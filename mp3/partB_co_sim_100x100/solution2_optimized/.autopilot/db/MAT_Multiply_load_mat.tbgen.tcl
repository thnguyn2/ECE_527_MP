...
set C_modelArgList { 
	...
	{ arrayX int 32000 regular {array 1000 { 2 3 } 3 1 }  }
	{ m int 32 regular  }
	{ n int 32 regular  }
}
...
set portList { 
	...
	{ arrayX_d0 sc_out sc_lv 32000 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "arrayX_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32000, "type": "signal", "bundle":{"name": "arrayX", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	arrayX { ap_memory {  { arrayX_address0 mem_address 1 10 }  { arrayX_ce0 mem_ce 1 1 }  { arrayX_we0 mem_we 1 1 }  { arrayX_d0 mem_din 1 32000 }  { arrayX_q0 mem_dout 0 32000 } } }
