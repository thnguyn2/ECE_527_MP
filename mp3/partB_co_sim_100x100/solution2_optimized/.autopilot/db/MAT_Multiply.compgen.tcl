...
set id 9
set name MAT_Multiply_lshr_32000ns_15ns_32000_2
...
set id 12
set name MAT_Multiply_mac_muladd_10ns_11ns_10ns_20_1
...
set out_width 20
set exp i0*i1+i2
set arg_lists {i0 {10 0 +} i1 {11 0 +} m {20 0 +} i2 {10 0 +} p {20 0 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
...
# Memory (RAM/ROM)  definition:
set ID 15
set MemName MAT_Multiply_arrayB
set CoreName ap_simcore_mem
set PortList { 1 0 }
set DataWd 32000
set AddrRange 1000
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_C \
    op interface \
    ports { C_din { O 64 vector } C_full_n { I 1 bit } C_write { O 1 bit } } \
} "
}
