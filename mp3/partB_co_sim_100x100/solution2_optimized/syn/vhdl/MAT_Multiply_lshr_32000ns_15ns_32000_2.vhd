...
entity MAT_Multiply_lshr_32000ns_15ns_32000_2 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 32000;  --data bitwidth
      din1_WIDTH : INTEGER := 32000;    --shift control bitwidth
      dout_WIDTH : INTEGER := 32000;  --output bitwidth
...
end entity MAT_Multiply_lshr_32000ns_15ns_32000_2;
architecture rtl of MAT_Multiply_lshr_32000ns_15ns_32000_2 is
