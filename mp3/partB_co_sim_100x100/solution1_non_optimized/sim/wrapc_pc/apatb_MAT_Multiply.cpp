...
void MAT_Multiply (int* A, int* B, long long* C, int mA, int nA, int mB, int nB, int mC, int nC)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<64> *C_pc_buffer = new sc_bv<64>[3];
			int i = 0;
			...
			if (i > 0)
			{
				sc_lv<64>* C_lv0_0_2_1 = new sc_lv<64>[3];
				AESL_i = 0;
				for (int i_0 = 0; i_0 <= 2; i_0 += 1)
				{
					if (&(C[0]) != NULL)
					{
						C_lv0_0_2_1[0 + AESL_i].range(63, 0) = sc_bv<64>(C_pc_buffer[0 + AESL_i].range(63, 0));
					}
				...
				for (int i_0 = 0; i_0 <= 2; i_0 += 1)
				{
					...
					if (&(C[0]) != NULL)
					{
						C[i_0] = (C_lv0_0_2_1[0 + AESL_i]).to_uint64();
					}
	...
	else
	{
		...
		sc_bv<32>* A_tvin_wrapc_buffer = new sc_bv<32>[3];
		...
		sc_bv<32>* B_tvin_wrapc_buffer = new sc_bv<32>[3];
		...
		sc_bv<64>* C_tvin_wrapc_buffer = new sc_bv<64>[3];
		...
		tcl_file.set_num(3, &tcl_file.C_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<64>* C_tvout_wrapc_buffer = new sc_bv<64>[3];
