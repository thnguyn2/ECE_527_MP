...
#ifndef __MAT_Multiply_arrayB_H__
#define __MAT_Multiply_arrayB_H__
...
struct MAT_Multiply_arrayB_ram : public sc_core::sc_module {

  static const unsigned DataWidth = 32000;
...
sc_core::sc_signal<sc_logic> we1_t1; 
   SC_CTOR(MAT_Multiply_arrayB_ram) {
...
MAT_Multiply_arrayB_ram* meminst;


SC_CTOR(MAT_Multiply_arrayB) {
meminst = new MAT_Multiply_arrayB_ram("MAT_Multiply_arrayB_ram");
