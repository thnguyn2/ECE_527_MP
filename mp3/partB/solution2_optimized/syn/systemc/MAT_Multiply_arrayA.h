...
#ifndef __MAT_Multiply_arrayA_H__
#define __MAT_Multiply_arrayA_H__
...
struct MAT_Multiply_arrayA_ram : public sc_core::sc_module {
...
sc_core::sc_signal<sc_lv<DataWidth> > q0_t1;
   SC_CTOR(MAT_Multiply_arrayA_ram) {
...
MAT_Multiply_arrayA_ram* meminst;


SC_CTOR(MAT_Multiply_arrayA) {
meminst = new MAT_Multiply_arrayA_ram("MAT_Multiply_arrayA_ram");
