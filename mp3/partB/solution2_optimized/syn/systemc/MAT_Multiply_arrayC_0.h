...
#ifndef __MAT_Multiply_arrayC_0_H__
#define __MAT_Multiply_arrayC_0_H__
...
struct MAT_Multiply_arrayC_0_ram : public sc_core::sc_module {
...
sc_core::sc_signal<sc_lv<DataWidth> > q0_t1;
   SC_CTOR(MAT_Multiply_arrayC_0_ram) {
...
SC_MODULE(MAT_Multiply_arrayC_0) {
...
MAT_Multiply_arrayC_0_ram* meminst;


SC_CTOR(MAT_Multiply_arrayC_0) {
meminst = new MAT_Multiply_arrayC_0_ram("MAT_Multiply_arrayC_0_ram");
