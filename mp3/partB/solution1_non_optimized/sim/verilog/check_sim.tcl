...
proc check_tvin_file {} {
    set rtlfilelist {
         "c.MAT_Multiply.autotvin_A.dat"
         "c.MAT_Multiply.autotvin_B.dat"
         "c.MAT_Multiply.autotvin_C.dat"
         "c.MAT_Multiply.autotvin_mA.dat"
         "c.MAT_Multiply.autotvin_nA.dat"
         "c.MAT_Multiply.autotvin_mB.dat"
         "c.MAT_Multiply.autotvin_nB.dat"
         "c.MAT_Multiply.autotvin_mC.dat"
         "c.MAT_Multiply.autotvin_nC.dat"
         "c.MAT_Multiply.autotvout_C.dat"
    }
...
proc check_tvout_file {} {
    set rtlfilelist {
         "rtl.MAT_Multiply.autotvout_C.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
