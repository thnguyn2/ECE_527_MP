...
; <label>:5                                       ; preds = %._crit_edge
  %tmp.23 = add i32 %j, %tmp.6, !dbg !63          ; [#uses=1 type=i32] [debug line = 26:6]
  %tmp.24 = zext i32 %tmp.23 to i64, !dbg !63     ; [#uses=1 type=i64] [debug line = 26:6]
  %B.addr = getelementptr inbounds i32* %B, i64 %tmp.24, !dbg !63 ; [#uses=1 type=i32*] [debug line = 26:6]
  %B.load = load i32* %B.addr, align 4, !dbg !63  ; [#uses=2 type=i32] [debug line = 26:6]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %B.load) nounwind
  %tmp.25 = zext i32 %j to i64, !dbg !63          ; [#uses=1 type=i64] [debug line = 26:6]
  %arrayB.addr = getelementptr inbounds [100 x [100 x i32]]* %arrayB, i64 0, i64 %tmp.7, i64 %tmp.25, !dbg !63 ; [#uses=1 type=i32*] [debug line = 26:6]
  store i32 %B.load, i32* %arrayB.addr, align 4, !dbg !63 ; [debug line = 26:6]
  br label %._crit_edge12, !dbg !63               ; [debug line = 26:6]

._crit_edge12:                                    ; preds = %5, %._crit_edge
  %or.cond8 = and i1 %tmp.5, %tmp.16, !dbg !64    ; [#uses=1 type=i1] [debug line = 27:5]
  br i1 %or.cond8, label %6, label %._crit_edge13, !dbg !64 ; [debug line = 27:5]

; <label>:6                                       ; preds = %._crit_edge12
  %tmp.27 = zext i32 %j to i64, !dbg !65          ; [#uses=1 type=i64] [debug line = 28:6]
  %arrayC.addr.1 = getelementptr inbounds [100 x [100 x i64]]* %arrayC, i64 0, i64 %tmp.7, i64 %tmp.27, !dbg !65 ; [#uses=1 type=i64*] [debug line = 28:6]
  store i64 0, i64* %arrayC.addr.1, align 8, !dbg !65 ; [debug line = 28:6]
  br label %._crit_edge13, !dbg !65               ; [debug line = 28:6]

._crit_edge13:                                    ; preds = %6, %._crit_edge12
  %rend19 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !66 ; [#uses=0 type=i32] [debug line = 30:4]
  %j.3 = add i32 %j, 1, !dbg !67                  ; [#uses=1 type=i32] [debug line = 21:29]
  call void @llvm.dbg.value(metadata !{i32 %j.3}, i64 0, metadata !68), !dbg !67 ; [debug line = 21:29] [debug variable = j]
  br label %2, !dbg !67                           ; [debug line = 21:29]

; <label>:7                                       ; preds = %2
  %rend27 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str2, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !69 ; [#uses=0 type=i32] [debug line = 30:4]
  %i.3 = add i32 %i, 1, !dbg !70                  ; [#uses=1 type=i32] [debug line = 20:28]
  call void @llvm.dbg.value(metadata !{i32 %i.3}, i64 0, metadata !71), !dbg !70 ; [debug line = 20:28] [debug variable = i]
  br label %.preheader11, !dbg !70                ; [debug line = 20:28]
...
.preheader.preheader:                             ; preds = %.preheader10
  br label %.preheader, !dbg !72                  ; [debug line = 43:20]

; <label>:8                                       ; preds = %.preheader10
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !74 ; [debug line = 32:4]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !74 ; [#uses=1 type=i32] [debug line = 32:4]
  %tmp.9 = icmp ult i32 %i.1, %mA, !dbg !76       ; [#uses=1 type=i1] [debug line = 34:5]
  %tmp.10 = zext i32 %i.1 to i64, !dbg !79        ; [#uses=2 type=i64] [debug line = 36:6]
  br label %9, !dbg !81                           ; [debug line = 32:14]

; <label>:9                                       ; preds = %.loopexit9, %8
  %j.1 = phi i32 [ 0, %8 ], [ %j.5, %.loopexit9 ] ; [#uses=4 type=i32]
  %exitcond3 = icmp eq i32 %j.1, 100, !dbg !81    ; [#uses=1 type=i1] [debug line = 32:14]
  br i1 %exitcond3, label %15, label %10, !dbg !81 ; [debug line = 32:14]

; <label>:10                                      ; preds = %9
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !82 ; [debug line = 33:5]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !82 ; [#uses=1 type=i32] [debug line = 33:5]
  %tmp.21 = icmp ult i32 %j.1, %nB, !dbg !76      ; [#uses=1 type=i1] [debug line = 34:5]
  %tmp.22 = and i1 %tmp.9, %tmp.21, !dbg !76      ; [#uses=1 type=i1] [debug line = 34:5]
  br i1 %tmp.22, label %11, label %.loopexit9, !dbg !76 ; [debug line = 34:5]

; <label>:11                                      ; preds = %10
  %tmp.26 = zext i32 %j.1 to i64, !dbg !79        ; [#uses=2 type=i64] [debug line = 36:6]
  %arrayC.addr = getelementptr inbounds [100 x [100 x i64]]* %arrayC, i64 0, i64 %tmp.10, i64 %tmp.26, !dbg !79 ; [#uses=3 type=i64*] [debug line = 36:6]
  store i64 0, i64* %arrayC.addr, align 8, !dbg !79 ; [debug line = 36:6]
  br label %12, !dbg !83                          ; [debug line = 37:20]

; <label>:12                                      ; preds = %._crit_edge14, %11
  %k = phi i32 [ 0, %11 ], [ %k.1, %._crit_edge14 ] ; [#uses=4 type=i32]
  %exitcond2 = icmp eq i32 %k, 100, !dbg !83      ; [#uses=1 type=i1] [debug line = 37:20]
  br i1 %exitcond2, label %.loopexit9.loopexit, label %13, !dbg !83 ; [debug line = 37:20]

; <label>:13                                      ; preds = %12
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !85 ; [debug line = 38:9]
  %rbegin6 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !85 ; [#uses=1 type=i32] [debug line = 38:9]
  %tmp.36 = icmp ult i32 %k, %nA, !dbg !85        ; [#uses=1 type=i1] [debug line = 38:9]
  br i1 %tmp.36, label %14, label %._crit_edge14, !dbg !85 ; [debug line = 38:9]

; <label>:14                                      ; preds = %13
  %tmp.38 = zext i32 %k to i64, !dbg !87          ; [#uses=2 type=i64] [debug line = 39:10]
  %arrayA.addr.1 = getelementptr inbounds [100 x [100 x i32]]* %arrayA, i64 0, i64 %tmp.10, i64 %tmp.38, !dbg !87 ; [#uses=1 type=i32*] [debug line = 39:10]
  %arrayA.load = load i32* %arrayA.addr.1, align 4, !dbg !87 ; [#uses=2 type=i32] [debug line = 39:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %arrayA.load) nounwind
  %arrayB.addr.1 = getelementptr inbounds [100 x [100 x i32]]* %arrayB, i64 0, i64 %tmp.38, i64 %tmp.26, !dbg !87 ; [#uses=1 type=i32*] [debug line = 39:10]
  %arrayB.load = load i32* %arrayB.addr.1, align 4, !dbg !87 ; [#uses=2 type=i32] [debug line = 39:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %arrayB.load) nounwind
  %tmp.39 = mul nsw i32 %arrayB.load, %arrayA.load, !dbg !87 ; [#uses=1 type=i32] [debug line = 39:10]
  %tmp.40 = sext i32 %tmp.39 to i64, !dbg !87     ; [#uses=1 type=i64] [debug line = 39:10]
  %arrayC.load.1 = load i64* %arrayC.addr, align 8, !dbg !87 ; [#uses=2 type=i64] [debug line = 39:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i64 %arrayC.load.1) nounwind
  %tmp.41 = add nsw i64 %arrayC.load.1, %tmp.40, !dbg !87 ; [#uses=1 type=i64] [debug line = 39:10]
  store i64 %tmp.41, i64* %arrayC.addr, align 8, !dbg !87 ; [debug line = 39:10]
  br label %._crit_edge14, !dbg !87               ; [debug line = 39:10]

._crit_edge14:                                    ; preds = %14, %13
  %rend21 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str6, i64 0, i64 0), i32 %rbegin6) nounwind, !dbg !88 ; [#uses=0 type=i32] [debug line = 39:52]
  %k.1 = add i32 %k, 1, !dbg !89                  ; [#uses=1 type=i32] [debug line = 37:32]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !90), !dbg !89 ; [debug line = 37:32] [debug variable = k]
  br label %12, !dbg !89                          ; [debug line = 37:32]

.loopexit9.loopexit:                              ; preds = %12
  br label %.loopexit9

.loopexit9:                                       ; preds = %.loopexit9.loopexit, %10
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str5, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !91 ; [#uses=0 type=i32] [debug line = 41:4]
  %j.5 = add i32 %j.1, 1, !dbg !92                ; [#uses=1 type=i32] [debug line = 32:26]
  call void @llvm.dbg.value(metadata !{i32 %j.5}, i64 0, metadata !68), !dbg !92 ; [debug line = 32:26] [debug variable = j]
  br label %9, !dbg !92                           ; [debug line = 32:26]

; <label>:15                                      ; preds = %9
  %rend23 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str4, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !93 ; [#uses=0 type=i32] [debug line = 41:4]
  %i.4 = add i32 %i.1, 1, !dbg !94                ; [#uses=1 type=i32] [debug line = 31:25]
  call void @llvm.dbg.value(metadata !{i32 %i.4}, i64 0, metadata !71), !dbg !94 ; [debug line = 31:25] [debug variable = i]
  br label %.preheader10, !dbg !94                ; [debug line = 31:25]

.preheader:                                       ; preds = %20, %.preheader.preheader
  %i.2 = phi i32 [ %i.5, %20 ], [ 0, %.preheader.preheader ] ; [#uses=5 type=i32]
  %exitcond1 = icmp eq i32 %i.2, 100, !dbg !72    ; [#uses=1 type=i1] [debug line = 43:20]
  br i1 %exitcond1, label %.loopexit.loopexit, label %16, !dbg !72 ; [debug line = 43:20]

; <label>:16                                      ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([11 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !95 ; [debug line = 44:6]
  %rbegin4 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([11 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !95 ; [#uses=1 type=i32] [debug line = 44:6]
  %tmp.17 = icmp ult i32 %i.2, %mA, !dbg !97      ; [#uses=1 type=i1] [debug line = 46:7]
  %tmp.18 = zext i32 %i.2 to i64, !dbg !100       ; [#uses=1 type=i64] [debug line = 48:8]
  %tmp.19 = mul i32 %i.2, 100, !dbg !100          ; [#uses=1 type=i32] [debug line = 48:8]
  br label %17, !dbg !102                         ; [debug line = 44:23]

; <label>:17                                      ; preds = %._crit_edge15, %16
  %j.2 = phi i32 [ 0, %16 ], [ %j.4, %._crit_edge15 ] ; [#uses=5 type=i32]
  %exitcond = icmp eq i32 %j.2, 100, !dbg !102    ; [#uses=1 type=i1] [debug line = 44:23]
  br i1 %exitcond, label %20, label %18, !dbg !102 ; [debug line = 44:23]

; <label>:18                                      ; preds = %17
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([11 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !103 ; [debug line = 45:7]
  %rbegin5 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([11 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !103 ; [#uses=1 type=i32] [debug line = 45:7]
  %tmp.30 = icmp ult i32 %j.2, %nB, !dbg !97      ; [#uses=1 type=i1] [debug line = 46:7]
  %tmp.31 = and i1 %tmp.17, %tmp.30, !dbg !97     ; [#uses=1 type=i1] [debug line = 46:7]
  br i1 %tmp.31, label %19, label %._crit_edge15, !dbg !97 ; [debug line = 46:7]

; <label>:19                                      ; preds = %18
  %tmp.32 = zext i32 %j.2 to i64, !dbg !100       ; [#uses=1 type=i64] [debug line = 48:8]
  %arrayC.addr.2 = getelementptr inbounds [100 x [100 x i64]]* %arrayC, i64 0, i64 %tmp.18, i64 %tmp.32, !dbg !100 ; [#uses=1 type=i64*] [debug line = 48:8]
  %arrayC.load = load i64* %arrayC.addr.2, align 8, !dbg !100 ; [#uses=2 type=i64] [debug line = 48:8]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i64 %arrayC.load) nounwind
  %tmp.33 = add i32 %j.2, %tmp.19, !dbg !100      ; [#uses=1 type=i32] [debug line = 48:8]
  %tmp.34 = zext i32 %tmp.33 to i64, !dbg !100    ; [#uses=1 type=i64] [debug line = 48:8]
  %C.addr = getelementptr inbounds i64* %C, i64 %tmp.34, !dbg !100 ; [#uses=1 type=i64*] [debug line = 48:8]
  store i64 %arrayC.load, i64* %C.addr, align 8, !dbg !100 ; [debug line = 48:8]
  br label %._crit_edge15, !dbg !104              ; [debug line = 49:7]

._crit_edge15:                                    ; preds = %19, %18
  %rend17 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([11 x i8]* @.str8, i64 0, i64 0), i32 %rbegin5) nounwind, !dbg !105 ; [#uses=0 type=i32] [debug line = 50:6]
  %j.4 = add i32 %j.2, 1, !dbg !106               ; [#uses=1 type=i32] [debug line = 44:35]
  call void @llvm.dbg.value(metadata !{i32 %j.4}, i64 0, metadata !68), !dbg !106 ; [debug line = 44:35] [debug variable = j]
  br label %17, !dbg !106                         ; [debug line = 44:35]

; <label>:20                                      ; preds = %17
  %rend25 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([11 x i8]* @.str7, i64 0, i64 0), i32 %rbegin4) nounwind, !dbg !107 ; [#uses=0 type=i32] [debug line = 50:6]
  %i.5 = add i32 %i.2, 1, !dbg !108               ; [#uses=1 type=i32] [debug line = 43:32]
  call void @llvm.dbg.value(metadata !{i32 %i.5}, i64 0, metadata !71), !dbg !108 ; [debug line = 43:32] [debug variable = i]
  br label %.preheader, !dbg !108                 ; [debug line = 43:32]

.loopexit.loopexit:                               ; preds = %.preheader
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %0
  ret void, !dbg !109                             ; [debug line = 53:1]
}
...
!63 = metadata !{i32 26, i32 6, metadata !57, null}
!64 = metadata !{i32 27, i32 5, metadata !57, null}
!65 = metadata !{i32 28, i32 6, metadata !57, null}
!66 = metadata !{i32 30, i32 4, metadata !57, null}
!67 = metadata !{i32 21, i32 29, metadata !58, null}
!68 = metadata !{i32 786688, metadata !35, metadata !"j", metadata !6, i32 17, metadata !13, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!69 = metadata !{i32 30, i32 4, metadata !58, null}
!70 = metadata !{i32 20, i32 28, metadata !50, null}
!71 = metadata !{i32 786688, metadata !35, metadata !"i", metadata !6, i32 17, metadata !13, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!72 = metadata !{i32 43, i32 20, metadata !73, null}
!73 = metadata !{i32 786443, metadata !51, i32 43, i32 15, metadata !6, i32 13} ; [ DW_TAG_lexical_block ]
!74 = metadata !{i32 32, i32 4, metadata !75, null}
!75 = metadata !{i32 786443, metadata !53, i32 32, i32 4, metadata !6, i32 7} ; [ DW_TAG_lexical_block ]
!76 = metadata !{i32 34, i32 5, metadata !77, null}
!77 = metadata !{i32 786443, metadata !78, i32 33, i32 4, metadata !6, i32 9} ; [ DW_TAG_lexical_block ]
!78 = metadata !{i32 786443, metadata !75, i32 32, i32 9, metadata !6, i32 8} ; [ DW_TAG_lexical_block ]
!79 = metadata !{i32 36, i32 6, metadata !80, null}
!80 = metadata !{i32 786443, metadata !77, i32 35, i32 5, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
!81 = metadata !{i32 32, i32 14, metadata !78, null}
!82 = metadata !{i32 33, i32 5, metadata !77, null}
!83 = metadata !{i32 37, i32 20, metadata !84, null}
!84 = metadata !{i32 786443, metadata !80, i32 37, i32 15, metadata !6, i32 11} ; [ DW_TAG_lexical_block ]
!85 = metadata !{i32 38, i32 9, metadata !86, null}
!86 = metadata !{i32 786443, metadata !84, i32 38, i32 9, metadata !6, i32 12} ; [ DW_TAG_lexical_block ]
!87 = metadata !{i32 39, i32 10, metadata !86, null}
!88 = metadata !{i32 39, i32 52, metadata !86, null}
!89 = metadata !{i32 37, i32 32, metadata !84, null}
!90 = metadata !{i32 786688, metadata !35, metadata !"k", metadata !6, i32 17, metadata !13, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!91 = metadata !{i32 41, i32 4, metadata !77, null}
!92 = metadata !{i32 32, i32 26, metadata !78, null}
!93 = metadata !{i32 41, i32 4, metadata !78, null}
!94 = metadata !{i32 31, i32 25, metadata !53, null}
!95 = metadata !{i32 44, i32 6, metadata !96, null}
!96 = metadata !{i32 786443, metadata !73, i32 44, i32 6, metadata !6, i32 14} ; [ DW_TAG_lexical_block ]
!97 = metadata !{i32 46, i32 7, metadata !98, null}
!98 = metadata !{i32 786443, metadata !99, i32 45, i32 6, metadata !6, i32 16} ; [ DW_TAG_lexical_block ]
!99 = metadata !{i32 786443, metadata !96, i32 44, i32 18, metadata !6, i32 15} ; [ DW_TAG_lexical_block ]
!100 = metadata !{i32 48, i32 8, metadata !101, null}
!101 = metadata !{i32 786443, metadata !98, i32 47, i32 7, metadata !6, i32 17} ; [ DW_TAG_lexical_block ]
!102 = metadata !{i32 44, i32 23, metadata !99, null}
!103 = metadata !{i32 45, i32 7, metadata !98, null}
!104 = metadata !{i32 49, i32 7, metadata !101, null}
!105 = metadata !{i32 50, i32 6, metadata !98, null}
!106 = metadata !{i32 44, i32 35, metadata !99, null}
!107 = metadata !{i32 50, i32 6, metadata !99, null}
!108 = metadata !{i32 43, i32 32, metadata !73, null}
!109 = metadata !{i32 53, i32 1, metadata !35, null}
