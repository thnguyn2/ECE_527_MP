; ModuleID = '/home/parallels/source_code/ECE_527_MP/mp3/parta/solution1_mm_non_optimized/.autopilot/db/a.g.1.bc'
...
; <label>:4                                       ; preds = %3
  ...
  br label %5, !dbg !55                           ; [debug line = 18:20]

; <label>:5                                       ; preds = %._crit_edge, %4
  %k = phi i8 [ 0, %4 ], [ %k.1, %._crit_edge ]   ; [#uses=4 type=i8]
  %exitcond = icmp eq i8 %k, 100, !dbg !55        ; [#uses=1 type=i1] [debug line = 18:20]
  br i1 %exitcond, label %.loopexit.loopexit, label %6, !dbg !55 ; [debug line = 18:20]

; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !57 ; [debug line = 19:9]
  %rbegin4 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !57 ; [#uses=1 type=i32] [debug line = 19:9]
  %tmp.11 = icmp ult i8 %k, %nA, !dbg !57         ; [#uses=1 type=i1] [debug line = 19:9]
  br i1 %tmp.11, label %7, label %._crit_edge, !dbg !57 ; [debug line = 19:9]

; <label>:7                                       ; preds = %6
  %tmp.13 = zext i8 %k to i64, !dbg !59           ; [#uses=2 type=i64] [debug line = 20:10]
  %A.addr = getelementptr inbounds [100 x i32]* %A, i64 %tmp.6, i64 %tmp.13, !dbg !59 ; [#uses=1 type=i32*] [debug line = 20:10]
  %A.load = load i32* %A.addr, align 4, !dbg !59  ; [#uses=2 type=i32] [debug line = 20:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %A.load) nounwind
  %B.addr = getelementptr inbounds [100 x i32]* %B, i64 %tmp.13, i64 %tmp.10, !dbg !59 ; [#uses=1 type=i32*] [debug line = 20:10]
  %B.load = load i32* %B.addr, align 4, !dbg !59  ; [#uses=2 type=i32] [debug line = 20:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %B.load) nounwind
  %tmp.14 = mul nsw i32 %B.load, %A.load, !dbg !59 ; [#uses=1 type=i32] [debug line = 20:10]
  %tmp.15 = sext i32 %tmp.14 to i64, !dbg !59     ; [#uses=1 type=i64] [debug line = 20:10]
  %C.load = load i64* %C.addr, align 8, !dbg !59  ; [#uses=2 type=i64] [debug line = 20:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i64 %C.load) nounwind
  %tmp.16 = add nsw i64 %C.load, %tmp.15, !dbg !59 ; [#uses=1 type=i64] [debug line = 20:10]
  store i64 %tmp.16, i64* %C.addr, align 8, !dbg !59 ; [debug line = 20:10]
  br label %._crit_edge, !dbg !59                 ; [debug line = 20:10]

._crit_edge:                                      ; preds = %7, %6
  %rend5 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0), i32 %rbegin4) nounwind, !dbg !60 ; [#uses=0 type=i32] [debug line = 20:37]
  %k.1 = add i8 %k, 1, !dbg !61                   ; [#uses=1 type=i8] [debug line = 18:32]
  call void @llvm.dbg.value(metadata !{i8 %k.1}, i64 0, metadata !62), !dbg !61 ; [debug line = 18:32] [debug variable = k]
  br label %5, !dbg !61                           ; [debug line = 18:32]

.loopexit.loopexit:                               ; preds = %5
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %3
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !63 ; [#uses=0 type=i32] [debug line = 22:4]
  %j.1 = add i8 %j, 1, !dbg !64                   ; [#uses=1 type=i8] [debug line = 13:26]
  call void @llvm.dbg.value(metadata !{i8 %j.1}, i64 0, metadata !65), !dbg !64 ; [debug line = 13:26] [debug variable = j]
  br label %2, !dbg !64                           ; [debug line = 13:26]

; <label>:8                                       ; preds = %2
  %rend7 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), i32 %rbegin6) nounwind, !dbg !66 ; [#uses=0 type=i32] [debug line = 22:4]
  %i.1 = add i8 %i, 1, !dbg !67                   ; [#uses=1 type=i8] [debug line = 12:25]
  call void @llvm.dbg.value(metadata !{i8 %i.1}, i64 0, metadata !68), !dbg !67 ; [debug line = 12:25] [debug variable = i]
  br label %.preheader, !dbg !67                  ; [debug line = 12:25]

.loopexit3.loopexit:                              ; preds = %.preheader
  br label %.loopexit3

.loopexit3:                                       ; preds = %.loopexit3.loopexit, %0
  ret void, !dbg !69                              ; [debug line = 24:1]
}
...
!55 = metadata !{i32 18, i32 20, metadata !56, null}
!56 = metadata !{i32 786443, metadata !52, i32 18, i32 15, metadata !6, i32 7} ; [ DW_TAG_lexical_block ]
!57 = metadata !{i32 19, i32 9, metadata !58, null}
!58 = metadata !{i32 786443, metadata !56, i32 19, i32 9, metadata !6, i32 8} ; [ DW_TAG_lexical_block ]
!59 = metadata !{i32 20, i32 10, metadata !58, null}
!60 = metadata !{i32 20, i32 37, metadata !58, null}
!61 = metadata !{i32 18, i32 32, metadata !56, null}
!62 = metadata !{i32 786688, metadata !39, metadata !"k", metadata !6, i32 9, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!63 = metadata !{i32 22, i32 4, metadata !49, null}
!64 = metadata !{i32 13, i32 26, metadata !50, null}
!65 = metadata !{i32 786688, metadata !39, metadata !"j", metadata !6, i32 9, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!66 = metadata !{i32 22, i32 4, metadata !50, null}
!67 = metadata !{i32 12, i32 25, metadata !44, null}
!68 = metadata !{i32 786688, metadata !39, metadata !"i", metadata !6, i32 9, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!69 = metadata !{i32 24, i32 1, metadata !39, null}
