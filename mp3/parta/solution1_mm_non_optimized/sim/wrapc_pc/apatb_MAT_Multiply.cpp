...
extern "C" void MAT_Multiply (int A[100][100], int B[100][100], long long C[100][100], char mA, char nA, char mB, char nB, char mC, char nC);

#define MAT_Multiply AESL_ORIG_DUT_MAT_Multiply
extern "C" void MAT_Multiply (int A[100][100], int B[100][100], long long C[100][100], char mA, char nA, char mB, char nB, char mC, char nC);
#undef MAT_Multiply

void MAT_Multiply (int A[100][100], int B[100][100], long long C[100][100], char mA, char nA, char mB, char nB, char mC, char nC)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<64> *C_pc_buffer = new sc_bv<64>[10000];
			int i = 0;
			...
			if (i > 0)
			{
				sc_lv<64>* C_lv0_0_99_1_lv1_0_99_1 = new sc_lv<64>[10000];
				AESL_i = 0;
				...
				for (int i_1 = 0; i_1 <= 99; i_1 += 1)
				{
					if (&(C[0][0]) != NULL)
					{
						C_lv0_0_99_1_lv1_0_99_1[0 + AESL_i].range(63, 0) = sc_bv<64>(C_pc_buffer[0 + AESL_i].range(63, 0));
					}
				...
				for (int i_1 = 0; i_1 <= 99; i_1 += 1)
				{
					...
					if (&(C[0][0]) != NULL)
					{
						C[i_0][i_1] = (C_lv0_0_99_1_lv1_0_99_1[0 + AESL_i]).to_uint64();
					}
	...
	else
	{
		...
		sc_bv<64>* C_tvin_wrapc_buffer = new sc_bv<64>[10000];
...
// [call_c_dut] ---------->
		...
		sc_bv<64>* C_tvout_wrapc_buffer = new sc_bv<64>[10000];
