...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("mC", 8, hls_out, 7, "ap_vld", "out_data", 1),
	Port_Property("mC_ap_vld", 1, hls_out, 7, "ap_vld", "out_vld", 1),
	Port_Property("nC", 8, hls_out, 8, "ap_vld", "out_data", 1),
	Port_Property("nC_ap_vld", 1, hls_out, 8, "ap_vld", "out_vld", 1),
};
