...
set C_modelArgList { 
	...
	{ mB uint 8 regular  }
	{ nB uint 8 regular  }
	{ mC int 8 regular {pointer 1}  }
	{ nC int 8 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "memory", "bitwidth" : 32,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "A","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 99,"step" : 1},{"low" : 0,"up" : 99,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "C", "interface" : "memory", "bitwidth" : 32,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "C","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 99,"step" : 1},{"low" : 0,"up" : 99,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "mC", "interface" : "wire", "bitwidth" : 8,"bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "mC","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "nC", "interface" : "wire", "bitwidth" : 8,"bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "nC","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ mC sc_out sc_lv 8 signal 7 } 
	{ mC_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ nC sc_out sc_lv 8 signal 8 } 
	{ nC_ap_vld sc_out sc_logic 1 outvld 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mC", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "mC", "role": "default" }} , 
 	{ "name": "mC_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "mC", "role": "ap_vld" }} , 
 	{ "name": "nC", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "nC", "role": "default" }} , 
 	{ "name": "nC_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "nC", "role": "ap_vld" }}  ]}
set Spec2ImplPortList { 
	...
	mC { ap_vld {  { mC out_data 1 8 }  { mC_ap_vld out_vld 1 1 } } }
	nC { ap_vld {  { nC out_data 1 8 }  { nC_ap_vld out_vld 1 1 } } }
}
