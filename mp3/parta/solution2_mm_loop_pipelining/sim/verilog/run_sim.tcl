...
if {[file isfile MAT_Multiply.autotvin.dat]} {
    file delete -force MAT_Multiply.autotvin.dat
}
if {[file isfile MAT_Multiply.autotvout.dat]} {
    file delete -force MAT_Multiply.autotvout.dat
}
