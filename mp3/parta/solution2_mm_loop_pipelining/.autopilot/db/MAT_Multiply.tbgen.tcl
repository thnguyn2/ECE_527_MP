...
set C_modelArgList { 
	...
	{ C int 64 regular {array 10000 { 2 2 } 1 1 }  }
	{ mA uint 8 regular  }
	{ nA uint 8 regular  }
	{ mB uint 8 regular  }
	{ nB uint 8 regular  }
...
set Spec2ImplPortList { 
	A { ap_memory {  { A_address0 mem_address 1 14 }  { A_ce0 mem_ce 1 1 }  { A_q0 mem_dout 0 32 }  { A_address1 mem_address 1 14 }  { A_ce1 mem_ce 1 1 }  { A_q1 mem_dout 0 32 } } }
	B { ap_memory {  { B_address0 mem_address 1 14 }  { B_ce0 mem_ce 1 1 }  { B_q0 mem_dout 0 32 }  { B_address1 mem_address 1 14 }  { B_ce1 mem_ce 1 1 }  { B_q1 mem_dout 0 32 } } }
	C { ap_memory {  { C_address0 mem_address 1 14 }  { C_ce0 mem_ce 1 1 }  { C_we0 mem_we 1 1 }  { C_d0 mem_din 1 64 }  { C_q0 mem_dout 0 64 }  { C_address1 mem_address 1 14 }  { C_ce1 mem_ce 1 1 }  { C_we1 mem_we 1 1 }  { C_d1 mem_din 1 64 }  { C_q1 mem_dout 0 64 } } }
