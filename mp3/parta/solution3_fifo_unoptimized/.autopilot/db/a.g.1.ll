; ModuleID = '/home/parallels/source_code/ECE_527_MP/mp3/parta/solution3_fifo_unoptimized/.autopilot/db/a.g.1.bc'
...
define void @MAT_Multiply([100 x i32]* %A, [100 x i32]* %B, [100 x i64]* %C, i8 zeroext %mA, i8 zeroext %nA, i8 zeroext %mB, i8 zeroext %nB, i8 zeroext %mC, i8 zeroext %nC) nounwind uwtable {
  ...
  %tmp = icmp eq i8 %nA, %mB, !dbg !43            ; [#uses=1 type=i1] [debug line = 10:2]
  %tmp.1 = icmp eq i8 %mA, %mC, !dbg !43          ; [#uses=1 type=i1] [debug line = 10:2]
  %tmp.2 = and i1 %tmp, %tmp.1, !dbg !43          ; [#uses=1 type=i1] [debug line = 10:2]
  %tmp.3 = icmp eq i8 %nB, %nC, !dbg !43          ; [#uses=1 type=i1] [debug line = 10:2]
  %tmp.4 = and i1 %tmp.2, %tmp.3, !dbg !43        ; [#uses=1 type=i1] [debug line = 10:2]
  br i1 %tmp.4, label %.preheader.preheader, label %.loopexit3, !dbg !43 ; [debug line = 10:2]

.preheader.preheader:                             ; preds = %0
  br label %.preheader, !dbg !44                  ; [debug line = 12:13]

.preheader:                                       ; preds = %8, %.preheader.preheader
  %i = phi i8 [ %i.1, %8 ], [ 0, %.preheader.preheader ] ; [#uses=4 type=i8]
  %exitcond2 = icmp eq i8 %i, 100, !dbg !44       ; [#uses=1 type=i1] [debug line = 12:13]
  br i1 %exitcond2, label %.loopexit3.loopexit, label %1, !dbg !44 ; [debug line = 12:13]

; <label>:1                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !47 ; [debug line = 13:4]
  %rbegin6 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !47 ; [#uses=1 type=i32] [debug line = 13:4]
  ...
  br label %2, !dbg !54                           ; [debug line = 13:14]

; <label>:2                                       ; preds = %.loopexit, %1
  %j = phi i8 [ 0, %1 ], [ %j.1, %.loopexit ]     ; [#uses=4 type=i8]
  %exitcond1 = icmp eq i8 %j, 100, !dbg !54       ; [#uses=1 type=i1] [debug line = 13:14]
  br i1 %exitcond1, label %8, label %3, !dbg !54  ; [debug line = 13:14]

; <label>:3                                       ; preds = %2
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !55 ; [debug line = 14:5]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !55 ; [#uses=1 type=i32] [debug line = 14:5]
...
; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !58 ; [debug line = 19:9]
  %rbegin4 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !58 ; [#uses=1 type=i32] [debug line = 19:9]
  %tmp.11 = icmp ult i8 %k, %nA, !dbg !58         ; [#uses=1 type=i1] [debug line = 19:9]
  br i1 %tmp.11, label %7, label %._crit_edge, !dbg !58 ; [debug line = 19:9]

; <label>:7                                       ; preds = %6
  %tmp.13 = zext i8 %k to i64, !dbg !60           ; [#uses=2 type=i64] [debug line = 20:10]
  %A.addr = getelementptr inbounds [100 x i32]* %A, i64 %tmp.6, i64 %tmp.13, !dbg !60 ; [#uses=1 type=i32*] [debug line = 20:10]
  %A.load = load i32* %A.addr, align 4, !dbg !60  ; [#uses=2 type=i32] [debug line = 20:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %A.load) nounwind
  %B.addr = getelementptr inbounds [100 x i32]* %B, i64 %tmp.13, i64 %tmp.10, !dbg !60 ; [#uses=1 type=i32*] [debug line = 20:10]
  %B.load = load i32* %B.addr, align 4, !dbg !60  ; [#uses=2 type=i32] [debug line = 20:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %B.load) nounwind
  %tmp.14 = mul nsw i32 %B.load, %A.load, !dbg !60 ; [#uses=1 type=i32] [debug line = 20:10]
  %tmp.15 = sext i32 %tmp.14 to i64, !dbg !60     ; [#uses=1 type=i64] [debug line = 20:10]
  %C.load = load i64* %C.addr, align 8, !dbg !60  ; [#uses=2 type=i64] [debug line = 20:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i64 %C.load) nounwind
  %tmp.16 = add nsw i64 %C.load, %tmp.15, !dbg !60 ; [#uses=1 type=i64] [debug line = 20:10]
  store i64 %tmp.16, i64* %C.addr, align 8, !dbg !60 ; [debug line = 20:10]
  br label %._crit_edge, !dbg !60                 ; [debug line = 20:10]

._crit_edge:                                      ; preds = %7, %6
  %rend5 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), i32 %rbegin4) nounwind, !dbg !61 ; [#uses=0 type=i32] [debug line = 20:37]
  %k.1 = add i8 %k, 1, !dbg !62                   ; [#uses=1 type=i8] [debug line = 18:32]
  call void @llvm.dbg.value(metadata !{i8 %k.1}, i64 0, metadata !63), !dbg !62 ; [debug line = 18:32] [debug variable = k]
  br label %5, !dbg !62                           ; [debug line = 18:32]

.loopexit.loopexit:                               ; preds = %5
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %3
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str3, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !64 ; [#uses=0 type=i32] [debug line = 22:4]
  %j.1 = add i8 %j, 1, !dbg !65                   ; [#uses=1 type=i8] [debug line = 13:26]
  call void @llvm.dbg.value(metadata !{i8 %j.1}, i64 0, metadata !66), !dbg !65 ; [debug line = 13:26] [debug variable = j]
  br label %2, !dbg !65                           ; [debug line = 13:26]

; <label>:8                                       ; preds = %2
  %rend7 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0), i32 %rbegin6) nounwind, !dbg !67 ; [#uses=0 type=i32] [debug line = 22:4]
  %i.1 = add i8 %i, 1, !dbg !68                   ; [#uses=1 type=i8] [debug line = 12:25]
  call void @llvm.dbg.value(metadata !{i8 %i.1}, i64 0, metadata !69), !dbg !68 ; [debug line = 12:25] [debug variable = i]
...
.loopexit3:                                       ; preds = %.loopexit3.loopexit, %0
  ret void, !dbg !70                              ; [debug line = 24:1]
}
...
!43 = metadata !{i32 10, i32 2, metadata !39, null}
!44 = metadata !{i32 12, i32 13, metadata !45, null}
!45 = metadata !{i32 786443, metadata !46, i32 12, i32 8, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!46 = metadata !{i32 786443, metadata !39, i32 11, i32 2, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!47 = metadata !{i32 13, i32 4, metadata !48, null}
!48 = metadata !{i32 786443, metadata !45, i32 13, i32 4, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
...
!51 = metadata !{i32 786443, metadata !48, i32 13, i32 9, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
...
!54 = metadata !{i32 13, i32 14, metadata !51, null}
!55 = metadata !{i32 14, i32 5, metadata !50, null}
!56 = metadata !{i32 18, i32 20, metadata !57, null}
!57 = metadata !{i32 786443, metadata !53, i32 18, i32 15, metadata !6, i32 7} ; [ DW_TAG_lexical_block ]
!58 = metadata !{i32 19, i32 9, metadata !59, null}
!59 = metadata !{i32 786443, metadata !57, i32 19, i32 9, metadata !6, i32 8} ; [ DW_TAG_lexical_block ]
!60 = metadata !{i32 20, i32 10, metadata !59, null}
!61 = metadata !{i32 20, i32 37, metadata !59, null}
!62 = metadata !{i32 18, i32 32, metadata !57, null}
!63 = metadata !{i32 786688, metadata !39, metadata !"k", metadata !6, i32 9, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!64 = metadata !{i32 22, i32 4, metadata !50, null}
!65 = metadata !{i32 13, i32 26, metadata !51, null}
!66 = metadata !{i32 786688, metadata !39, metadata !"j", metadata !6, i32 9, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!67 = metadata !{i32 22, i32 4, metadata !51, null}
!68 = metadata !{i32 12, i32 25, metadata !45, null}
!69 = metadata !{i32 786688, metadata !39, metadata !"i", metadata !6, i32 9, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!70 = metadata !{i32 24, i32 1, metadata !39, null}
