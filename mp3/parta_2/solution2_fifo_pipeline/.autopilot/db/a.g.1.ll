; ModuleID = 'Z:/Documents/UIUC/ECE527/ECE_527_MP/mp3/parta_2/solution2_fifo_pipeline/.autopilot/db/a.g.1.bc'
...
define void @MAT_Multiply([100 x i32]* %A, [100 x i32]* %B, [100 x i32]* %C, i8 zeroext %mA, i8 zeroext %nA, i8 zeroext %mB, i8 zeroext %nB, i8 zeroext %mC, i8 zeroext %nC) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecInterface([100 x i32]* %C, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !42 ; [debug line = 9:1]
  call void (...)* @_ssdm_op_SpecInterface([100 x i32]* %B, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !42 ; [debug line = 9:1]
  call void (...)* @_ssdm_op_SpecInterface([100 x i32]* %A, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !42 ; [debug line = 9:1]
...
; <label>:1                                       ; preds = %.preheader7
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0)), !dbg !53 ; [debug line = 17:4]
...
; <label>:3                                       ; preds = %2
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str3, i64 0, i64 0)), !dbg !62 ; [debug line = 18:5]
...
; <label>:5                                       ; preds = %.preheader5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([11 x i8]* @.str4, i64 0, i64 0)), !dbg !67 ; [debug line = 28:2]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([11 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !67 ; [#uses=1 type=i32] [debug line = 28:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !69 ; [debug line = 29:1]
  %tmp.12 = zext i8 %k to i64, !dbg !70           ; [#uses=2 type=i64] [debug line = 28:1]
  %A.addr = getelementptr inbounds [100 x i32]* %A, i64 %tmp.7, i64 %tmp.12, !dbg !70 ; [#uses=1 type=i32*] [debug line = 28:1]
  %A.load = load i32* %A.addr, align 4, !dbg !70  ; [#uses=2 type=i32] [debug line = 28:1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %A.load) nounwind
  %A_cached_row.addr = getelementptr inbounds [100 x i32]* %A_cached_row, i64 0, i64 %tmp.12, !dbg !70 ; [#uses=1 type=i32*] [debug line = 28:1]
  store i32 %A.load, i32* %A_cached_row.addr, align 4, !dbg !70 ; [debug line = 28:1]
  %rend17 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([11 x i8]* @.str4, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !71 ; [#uses=0 type=i32] [debug line = 28:23]
  %k.3 = add i8 %k, 1, !dbg !72                   ; [#uses=1 type=i8] [debug line = 27:34]
  call void @llvm.dbg.value(metadata !{i8 %k.3}, i64 0, metadata !73), !dbg !72 ; [debug line = 27:34] [debug variable = k]
  br label %.preheader5, !dbg !72                 ; [debug line = 27:34]
...
.preheader.preheader:                             ; preds = %.loopexit6
  %tmp.14 = zext i8 %j to i64, !dbg !74           ; [#uses=2 type=i64] [debug line = 35:1]
  br label %.preheader, !dbg !78                  ; [debug line = 34:24]

.preheader:                                       ; preds = %6, %.preheader.preheader
  %k.1 = phi i8 [ %k.4, %6 ], [ 0, %.preheader.preheader ] ; [#uses=3 type=i8]
  %exitcond1 = icmp eq i8 %k.1, 100, !dbg !78     ; [#uses=1 type=i1] [debug line = 34:24]
  br i1 %exitcond1, label %.loopexit.loopexit, label %6, !dbg !78 ; [debug line = 34:24]

; <label>:6                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([11 x i8]* @.str5, i64 0, i64 0)), !dbg !79 ; [debug line = 35:2]
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([11 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !79 ; [#uses=1 type=i32] [debug line = 35:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !80 ; [debug line = 36:1]
  %tmp.15 = zext i8 %k.1 to i64, !dbg !74         ; [#uses=2 type=i64] [debug line = 35:1]
  %B.addr = getelementptr inbounds [100 x i32]* %B, i64 %tmp.15, i64 %tmp.14, !dbg !74 ; [#uses=1 type=i32*] [debug line = 35:1]
  %B.load = load i32* %B.addr, align 4, !dbg !74  ; [#uses=2 type=i32] [debug line = 35:1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %B.load) nounwind
  %B_cached.addr = getelementptr inbounds [100 x [100 x i32]]* %B_cached, i64 0, i64 %tmp.15, i64 %tmp.14, !dbg !74 ; [#uses=1 type=i32*] [debug line = 35:1]
  store i32 %B.load, i32* %B_cached.addr, align 4, !dbg !74 ; [debug line = 35:1]
  %rend11 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([11 x i8]* @.str5, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !81 ; [#uses=0 type=i32] [debug line = 35:22]
  %k.4 = add i8 %k.1, 1, !dbg !82                 ; [#uses=1 type=i8] [debug line = 34:34]
  call void @llvm.dbg.value(metadata !{i8 %k.4}, i64 0, metadata !73), !dbg !82 ; [debug line = 34:34] [debug variable = k]
  br label %.preheader, !dbg !82                  ; [debug line = 34:34]

.loopexit.loopexit:                               ; preds = %.preheader
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %.loopexit6
  %tmp.17 = zext i8 %j to i64, !dbg !83           ; [#uses=2 type=i64] [debug line = 41:10]
  br label %7, !dbg !86                           ; [debug line = 38:20]

; <label>:7                                       ; preds = %._crit_edge9, %.loopexit
  %k.2 = phi i8 [ 0, %.loopexit ], [ %k.5, %._crit_edge9 ] ; [#uses=4 type=i8]
  %temp = phi i32 [ 0, %.loopexit ], [ %temp.1, %._crit_edge9 ] ; [#uses=3 type=i32]
  %exitcond = icmp eq i8 %k.2, 100, !dbg !86      ; [#uses=1 type=i1] [debug line = 38:20]
  br i1 %exitcond, label %10, label %8, !dbg !86  ; [debug line = 38:20]

; <label>:8                                       ; preds = %7
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str6, i64 0, i64 0)), !dbg !87 ; [debug line = 39:7]
  %rbegin4 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !87 ; [#uses=1 type=i32] [debug line = 39:7]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !88 ; [debug line = 40:1]
  %tmp.18 = icmp ult i8 %k.2, %nA, !dbg !89       ; [#uses=1 type=i1] [debug line = 40:9]
  br i1 %tmp.18, label %9, label %._crit_edge9, !dbg !89 ; [debug line = 40:9]

; <label>:9                                       ; preds = %8
  %tmp.20 = zext i8 %k.2 to i64, !dbg !83         ; [#uses=2 type=i64] [debug line = 41:10]
  %A_cached_row.addr.1 = getelementptr inbounds [100 x i32]* %A_cached_row, i64 0, i64 %tmp.20, !dbg !83 ; [#uses=1 type=i32*] [debug line = 41:10]
  %A_cached_row.load = load i32* %A_cached_row.addr.1, align 4, !dbg !83 ; [#uses=2 type=i32] [debug line = 41:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %A_cached_row.load) nounwind
  %B_cached.addr.1 = getelementptr inbounds [100 x [100 x i32]]* %B_cached, i64 0, i64 %tmp.20, i64 %tmp.17, !dbg !83 ; [#uses=1 type=i32*] [debug line = 41:10]
  %B_cached.load = load i32* %B_cached.addr.1, align 4, !dbg !83 ; [#uses=2 type=i32] [debug line = 41:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %B_cached.load) nounwind
  %tmp.21 = mul nsw i32 %B_cached.load, %A_cached_row.load, !dbg !83 ; [#uses=1 type=i32] [debug line = 41:10]
  %temp.2 = add nsw i32 %tmp.21, %temp, !dbg !83  ; [#uses=1 type=i32] [debug line = 41:10]
  call void @llvm.dbg.value(metadata !{i32 %temp.2}, i64 0, metadata !90), !dbg !83 ; [debug line = 41:10] [debug variable = temp]
  br label %._crit_edge9, !dbg !83                ; [debug line = 41:10]

._crit_edge9:                                     ; preds = %9, %8
  %temp.1 = phi i32 [ %temp.2, %9 ], [ %temp, %8 ] ; [#uses=1 type=i32]
  %rend13 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str6, i64 0, i64 0), i32 %rbegin4) nounwind, !dbg !91 ; [#uses=0 type=i32] [debug line = 42:6]
  %k.5 = add i8 %k.2, 1, !dbg !92                 ; [#uses=1 type=i8] [debug line = 38:32]
  call void @llvm.dbg.value(metadata !{i8 %k.5}, i64 0, metadata !73), !dbg !92 ; [debug line = 38:32] [debug variable = k]
  br label %7, !dbg !92                           ; [debug line = 38:32]

; <label>:10                                      ; preds = %7
  %temp.0.lcssa = phi i32 [ %temp, %7 ]           ; [#uses=1 type=i32]
  %C.addr = getelementptr inbounds [100 x i32]* %C, i64 %tmp.7, i64 %tmp.17, !dbg !60 ; [#uses=1 type=i32*] [debug line = 43:6]
  store i32 %temp.0.lcssa, i32* %C.addr, align 4, !dbg !60 ; [debug line = 43:6]
  br label %._crit_edge, !dbg !93                 ; [debug line = 44:5]

._crit_edge:                                      ; preds = %10, %3
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str3, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !94 ; [#uses=0 type=i32] [debug line = 45:4]
  %j.1 = add i8 %j, 1, !dbg !95                   ; [#uses=1 type=i8] [debug line = 17:26]
  call void @llvm.dbg.value(metadata !{i8 %j.1}, i64 0, metadata !96), !dbg !95 ; [debug line = 17:26] [debug variable = j]
  br label %2, !dbg !95                           ; [debug line = 17:26]

; <label>:11                                      ; preds = %2
  %rend15 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !97 ; [#uses=0 type=i32] [debug line = 45:4]
  %i.1 = add i8 %i, 1, !dbg !98                   ; [#uses=1 type=i8] [debug line = 16:25]
  call void @llvm.dbg.value(metadata !{i8 %i.1}, i64 0, metadata !99), !dbg !98 ; [debug line = 16:25] [debug variable = i]
  br label %.preheader7, !dbg !98                 ; [debug line = 16:25]

.loopexit8.loopexit:                              ; preds = %.preheader7
  br label %.loopexit8

.loopexit8:                                       ; preds = %.loopexit8.loopexit, %0
  ret void, !dbg !100                             ; [debug line = 47:1]
}
...
!6 = metadata !{i32 786473, metadata !"parta_2/matrixmath.c", metadata !"z:/Documents/UIUC/ECE527/ECE_527_MP/mp3", null} ; [ DW_TAG_file_type ]
...
!67 = metadata !{i32 28, i32 2, metadata !68, null}
!68 = metadata !{i32 786443, metadata !65, i32 28, i32 1, metadata !6, i32 9} ; [ DW_TAG_lexical_block ]
!69 = metadata !{i32 29, i32 1, metadata !68, null}
!70 = metadata !{i32 28, i32 1, metadata !68, null}
!71 = metadata !{i32 28, i32 23, metadata !68, null}
!72 = metadata !{i32 27, i32 34, metadata !65, null}
!73 = metadata !{i32 786688, metadata !39, metadata !"k", metadata !6, i32 9, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!74 = metadata !{i32 35, i32 1, metadata !75, null}
!75 = metadata !{i32 786443, metadata !76, i32 35, i32 1, metadata !6, i32 12} ; [ DW_TAG_lexical_block ]
!76 = metadata !{i32 786443, metadata !77, i32 34, i32 19, metadata !6, i32 11} ; [ DW_TAG_lexical_block ]
!77 = metadata !{i32 786443, metadata !59, i32 33, i32 6, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
!78 = metadata !{i32 34, i32 24, metadata !76, null}
!79 = metadata !{i32 35, i32 2, metadata !75, null}
!80 = metadata !{i32 36, i32 1, metadata !75, null}
!81 = metadata !{i32 35, i32 22, metadata !75, null}
!82 = metadata !{i32 34, i32 34, metadata !76, null}
!83 = metadata !{i32 41, i32 10, metadata !84, null}
!84 = metadata !{i32 786443, metadata !85, i32 39, i32 6, metadata !6, i32 14} ; [ DW_TAG_lexical_block ]
!85 = metadata !{i32 786443, metadata !59, i32 38, i32 15, metadata !6, i32 13} ; [ DW_TAG_lexical_block ]
!86 = metadata !{i32 38, i32 20, metadata !85, null}
!87 = metadata !{i32 39, i32 7, metadata !84, null}
!88 = metadata !{i32 40, i32 1, metadata !84, null}
!89 = metadata !{i32 40, i32 9, metadata !84, null}
!90 = metadata !{i32 786688, metadata !39, metadata !"temp", metadata !6, i32 10, metadata !16, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!91 = metadata !{i32 42, i32 6, metadata !84, null}
!92 = metadata !{i32 38, i32 32, metadata !85, null}
!93 = metadata !{i32 44, i32 5, metadata !59, null}
!94 = metadata !{i32 45, i32 4, metadata !56, null}
!95 = metadata !{i32 17, i32 26, metadata !57, null}
!96 = metadata !{i32 786688, metadata !39, metadata !"j", metadata !6, i32 9, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!97 = metadata !{i32 45, i32 4, metadata !57, null}
!98 = metadata !{i32 16, i32 25, metadata !51, null}
!99 = metadata !{i32 786688, metadata !39, metadata !"i", metadata !6, i32 9, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!100 = metadata !{i32 47, i32 1, metadata !39, null}
