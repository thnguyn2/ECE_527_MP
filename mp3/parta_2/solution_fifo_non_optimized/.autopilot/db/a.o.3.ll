; ModuleID = '/home/parallels/source_code/ECE_527_MP/mp3/parta_2/solution_fifo_non_optimized/.autopilot/db/a.o.3.bc'
...
define void @MAT_Multiply(i32* %A, i32* %B, i64* %C, i8 %mA, i8 %nA, i8 %mB, i8 %nB, i8 %mC, i8 %nC) {
  ...
  call void @llvm.dbg.value(metadata !{i64* %C}, i64 0, metadata !73), !dbg !75 ; [debug line = 5:23] [debug variable = C]
...
; <label>:2                                       ; preds = %.loopexit, %1
  %j = phi i6 [ 0, %1 ], [ %j_1, %.loopexit ]     ; [#uses=6 type=i6]
...
.preheader6:                                      ; preds = %5, %4
  %k = phi i6 [ %k_3, %5 ], [ 0, %4 ]             ; [#uses=3 type=i6]
...
; <label>:5                                       ; preds = %.preheader6
  call void (...)* @_ssdm_op_SpecLoopName([11 x i8]* @p_str4) nounwind, !dbg !101 ; [debug line = 27:8]
  %tmp_10 = zext i6 %k to i64, !dbg !101          ; [#uses=1 type=i64] [debug line = 27:8]
  %A_read = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %A), !dbg !101 ; [#uses=1 type=i32] [debug line = 27:8]
  %A_cached_row_addr = getelementptr inbounds [50 x i32]* %A_cached_row, i64 0, i64 %tmp_10, !dbg !101 ; [#uses=1 type=i32*] [debug line = 27:8]
  store i32 %A_read, i32* %A_cached_row_addr, align 4, !dbg !101 ; [debug line = 27:8]
...
.preheader.preheader:                             ; preds = %.loopexit7
  %tmp_11_trn_cast = zext i6 %j to i12, !dbg !104 ; [#uses=1 type=i12] [debug line = 33:24]
...
; <label>:6                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName([11 x i8]* @p_str5) nounwind, !dbg !108 ; [debug line = 34:8]
  %B_read = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %B), !dbg !108 ; [#uses=1 type=i32] [debug line = 34:8]
  %next_mul = add i12 %phi_mul, 50                ; [#uses=1 type=i12]
  %p_addr3 = add i12 %tmp_11_trn_cast, %phi_mul, !dbg !108 ; [#uses=1 type=i12] [debug line = 34:8]
  %tmp_11 = zext i12 %p_addr3 to i64, !dbg !108   ; [#uses=1 type=i64] [debug line = 34:8]
  %B_cached_addr = getelementptr [2500 x i32]* %B_cached, i64 0, i64 %tmp_11, !dbg !108 ; [#uses=1 type=i32*] [debug line = 34:8]
  store i32 %B_read, i32* %B_cached_addr, align 4, !dbg !108 ; [debug line = 34:8]
...
; <label>:7                                       ; preds = %_ifconv, %.loopexit5
  ...
  %phi_mul4 = phi i12 [ 0, %.loopexit5 ], [ %next_mul5, %_ifconv ] ; [#uses=2 type=i12]
...
_ifconv:                                          ; preds = %7
  call void (...)* @_ssdm_op_SpecLoopName([8 x i8]* @p_str6) nounwind, !dbg !113 ; [debug line = 38:7]
  %tmp_12 = icmp ult i8 %k_2_cast2, %mB_read, !dbg !115 ; [#uses=1 type=i1] [debug line = 39:9]
  %tmp_13 = zext i6 %k_2 to i64, !dbg !116        ; [#uses=1 type=i64] [debug line = 40:10]
  %A_cached_row_addr_1 = getelementptr inbounds [50 x i32]* %A_cached_row, i64 0, i64 %tmp_13, !dbg !116 ; [#uses=1 type=i32*] [debug line = 40:10]
  %A_cached_row_load = load i32* %A_cached_row_addr_1, align 4, !dbg !116 ; [#uses=1 type=i32] [debug line = 40:10]
  %next_mul5 = add i12 %phi_mul4, 50              ; [#uses=1 type=i12]
  %p_addr1 = add i12 %tmp_13_trn_cast, %phi_mul4, !dbg !116 ; [#uses=1 type=i12] [debug line = 40:10]
  %tmp_14 = zext i12 %p_addr1 to i64, !dbg !116   ; [#uses=1 type=i64] [debug line = 40:10]
  %B_cached_addr_1 = getelementptr [2500 x i32]* %B_cached, i64 0, i64 %tmp_14, !dbg !116 ; [#uses=1 type=i32*] [debug line = 40:10]
  %B_cached_load = load i32* %B_cached_addr_1, align 4, !dbg !116 ; [#uses=1 type=i32] [debug line = 40:10]
  %tmp_15 = mul nsw i32 %B_cached_load, %A_cached_row_load, !dbg !116 ; [#uses=1 type=i32] [debug line = 40:10]
  %tmp_16 = sext i32 %tmp_15 to i64, !dbg !116    ; [#uses=1 type=i64] [debug line = 40:10]
  %temp_3 = add nsw i64 %temp, %tmp_16, !dbg !116 ; [#uses=1 type=i64] [debug line = 40:10]
  call void @llvm.dbg.value(metadata !{i64 %temp_3}, i64 0, metadata !117), !dbg !116 ; [debug line = 40:10] [debug variable = temp]
  %temp_1 = select i1 %tmp_12, i64 %temp_3, i64 %temp ; [#uses=1 type=i64]
...
.loopexit:                                        ; preds = %7, %3
  ...
  call void @_ssdm_op_Write.ap_fifo.volatile.i64P(i64* %C, i64 %temp_2), !dbg !118 ; [debug line = 43:5]
  %empty_8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str3, i32 %tmp_2) nounwind, !dbg !119 ; [#uses=0 type=i32] [debug line = 44:4]
...
; <label>:8                                       ; preds = %2
  %empty_9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str2, i32 %tmp_7) nounwind, !dbg !121 ; [#uses=0 type=i32] [debug line = 44:4]
