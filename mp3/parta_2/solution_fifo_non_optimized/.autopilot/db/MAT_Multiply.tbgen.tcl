...
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "fifo", "bitwidth" : 32,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "A","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 49,"step" : 1},{"low" : 0,"up" : 49,"step" : 1}]}]}]} , 
 	{ "Name" : "B", "interface" : "fifo", "bitwidth" : 32,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "B","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 49,"step" : 1},{"low" : 0,"up" : 49,"step" : 1}]}]}]} , 
 	{ "Name" : "C", "interface" : "fifo", "bitwidth" : 64,"bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "C","cData": "long int","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 49,"step" : 1},{"low" : 0,"up" : 49,"step" : 1}]}]}]} , 
...
set fifoSchedulingInfoList { 
	A { fifo_read 50 has_conditional }
	B { fifo_read 50 has_conditional }
	C { fifo_write 50 has_conditional }
}
