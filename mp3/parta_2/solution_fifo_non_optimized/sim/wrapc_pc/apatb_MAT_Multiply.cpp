...
extern "C" void MAT_Multiply (int A[50][50], int B[50][50], long long C[50][50], char mA, char nA, char mB, char nB, char mC, char nC);

#define MAT_Multiply AESL_ORIG_DUT_MAT_Multiply
extern "C" void MAT_Multiply (int A[50][50], int B[50][50], long long C[50][50], char mA, char nA, char mB, char nB, char mC, char nC);
#undef MAT_Multiply

void MAT_Multiply (int A[50][50], int B[50][50], long long C[50][50], char mA, char nA, char mB, char nB, char mC, char nC)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<64> *C_pc_buffer = new sc_bv<64>[2500];
			int i = 0;
			...
			if (i > 0)
			{
				sc_lv<64>* C_lv0_0_49_1_lv1_0_49_1 = new sc_lv<64>[2500];
				AESL_i = 0;
				...
				for (int i_1 = 0; i_1 <= 49; i_1 += 1)
				{
					if (&(C[0][0]) != NULL)
					{
						C_lv0_0_49_1_lv1_0_49_1[0 + AESL_i].range(63, 0) = sc_bv<64>(C_pc_buffer[0 + AESL_i].range(63, 0));
					}
				...
				for (int i_1 = 0; i_1 <= 49; i_1 += 1)
				{
					...
					if (&(C[0][0]) != NULL)
					{
						C[i_0][i_1] = (C_lv0_0_49_1_lv1_0_49_1[0 + AESL_i]).to_uint64();
					}
	...
	else
	{
		...
		sc_bv<32>* A_tvin_wrapc_buffer = new sc_bv<32>[2500];
		...
		tcl_file.set_num(2500, &tcl_file.A_depth);
		...
		sc_bv<32>* B_tvin_wrapc_buffer = new sc_bv<32>[2500];
		...
		tcl_file.set_num(2500, &tcl_file.B_depth);
		...
		sc_bv<64>* C_tvin_wrapc_buffer = new sc_bv<64>[2500];
		...
		tcl_file.set_num(2500, &tcl_file.C_depth);
			...
			// bitslice(7, 0)
			{
				...
				// celement: mA(7, 0)
				{
					...
					if (&(mA) != NULL) // check the null address if the c port is array or others
					{
						sc_lv<8> mA_tmp_mem;
						mA_tmp_mem = mA;
						mA_tvin_wrapc_buffer.range(7, 0) = mA_tmp_mem.range(7, 0);
					}
				}
			}
		}
			...
			// bitslice(7, 0)
			{
				...
				// celement: nA(7, 0)
				{
					...
					if (&(nA) != NULL) // check the null address if the c port is array or others
					{
						sc_lv<8> nA_tmp_mem;
						nA_tmp_mem = nA;
						nA_tvin_wrapc_buffer.range(7, 0) = nA_tmp_mem.range(7, 0);
					}
				}
			}
		}
			...
			// bitslice(7, 0)
			{
				...
				// celement: mB(7, 0)
				{
					...
					if (&(mB) != NULL) // check the null address if the c port is array or others
					{
						sc_lv<8> mB_tmp_mem;
						mB_tmp_mem = mB;
						mB_tvin_wrapc_buffer.range(7, 0) = mB_tmp_mem.range(7, 0);
					}
				}
			}
		}
			...
			// bitslice(7, 0)
			{
				...
				// celement: nB(7, 0)
				{
					...
					if (&(nB) != NULL) // check the null address if the c port is array or others
					{
						sc_lv<8> nB_tmp_mem;
						nB_tmp_mem = nB;
						nB_tvin_wrapc_buffer.range(7, 0) = nB_tmp_mem.range(7, 0);
					}
				}
			}
		}
			...
			// bitslice(7, 0)
			{
				...
				// celement: mC(7, 0)
				{
					...
					if (&(mC) != NULL) // check the null address if the c port is array or others
					{
						sc_lv<8> mC_tmp_mem;
						mC_tmp_mem = mC;
						mC_tvin_wrapc_buffer.range(7, 0) = mC_tmp_mem.range(7, 0);
					}
				}
			}
		}
			...
			// bitslice(7, 0)
			{
				...
				// celement: nC(7, 0)
				{
					...
					if (&(nC) != NULL) // check the null address if the c port is array or others
					{
						sc_lv<8> nC_tmp_mem;
						nC_tmp_mem = nC;
						nC_tvin_wrapc_buffer.range(7, 0) = nC_tmp_mem.range(7, 0);
					}
				}
			}
		}
...
// [call_c_dut] ---------->
		...
		sc_bv<64>* C_tvout_wrapc_buffer = new sc_bv<64>[2500];
