...
################################################################
# This is a generated script based on design: hardwareplatform
#
...
# source hardwareplatform_script.tcl
...
set design_name hardwareplatform
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.A_Type {Signed} CONFIG.A_Width {32} CONFIG.B_Constant {true} CONFIG.B_Type {Signed} CONFIG.B_Value {00000000000000000000000000001010} CONFIG.B_Width {32} CONFIG.CE {false} CONFIG.Latency {0} CONFIG.Latency_Configuration {Manual} CONFIG.Out_Width {32}  ] $c_addsub_0
  ...
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata [get_bd_pins axi_dma_0/m_axis_mm2s_tdata] [get_bd_pins c_addsub_0/A]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net c_addsub_0_S [get_bd_pins axis_data_fifo_0/s_axis_tdata] [get_bd_pins c_addsub_0/S]
