...
set Library     "hls"
set IPName      "xillybus_wrapper"
set Version     "1.0"
set DisplayName "Xillybus_wrapper"
set Revision    "1510281720"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "xillybus_wrapper"
...
proc add_bus_interface {core name type mode {preferred_usage_value "ALL"} {has_dependant_on "0"} {offset_slave_name "s_axi_AXILiteS"}} {
    # {{{
    set properties ""
    switch -- $type {
        axi4 -
    ...
    switch -nocase -- $type {
        ...
        native_axim {
           ...
           if {$HasOffset==0} {
            ...
            ## axi4
            set current_bus_interface [add_bus_interface $core $interface_name axi4 $mode $preferred_usage_value $has_dependant_on $offset_slave_name]
...
if {![regexp -nocase {2014\.3.*} $vivado_version match]} {
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 13 II x}
