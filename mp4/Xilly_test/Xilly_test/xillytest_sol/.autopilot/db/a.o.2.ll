...
define void @xillybus_wrapper(i32* %in, i32* %out) nounwind uwtable {
  ...
  %in.load = load i32* %in, align 4, !dbg !55     ; [#uses=1 type=i32] [debug line = 11:2]
  store i32 %in.load, i32* %out, align 4, !dbg !55 ; [debug line = 11:2]
  ret void, !dbg !56                              ; [debug line = 12:1]
}
...
!55 = metadata !{i32 11, i32 2, metadata !52, null}
!56 = metadata !{i32 12, i32 1, metadata !52, null}
