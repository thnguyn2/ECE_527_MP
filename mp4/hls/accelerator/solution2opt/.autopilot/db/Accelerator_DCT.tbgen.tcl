set moduleName Accelerator_DCT
...
set isOneStateSeq 0
set C_modelName {Accelerator_DCT}
...
set portList { 
	...
	{ function_r_ap_vld sc_in sc_logic 1 invld 1 } 
...
set NewPortList {[ 
	{ "name": "X_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "X", "role": "dout" }} , 
 	...
 	{ "name": "function_r_ap_vld", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "function_r", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	function_r { ap_none {  { function_r in_data 0 8 }  { function_r_ap_vld in_vld 0 1 }  { function_r_ap_ack in_acc 1 1 } } }
