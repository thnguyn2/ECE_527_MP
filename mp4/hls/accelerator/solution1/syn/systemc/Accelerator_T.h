...
#ifndef __Accelerator_T_H__
#define __Accelerator_T_H__
...
struct Accelerator_T_ram : public sc_core::sc_module {
...
Accelerator_T_ram* meminst;


SC_CTOR(Accelerator_T) {
meminst = new Accelerator_T_ram("Accelerator_T_ram");
