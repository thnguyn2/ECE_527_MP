...
entity Accelerator_Tinv_rom is 
    generic(
             dwidth     : integer := 32; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of Accelerator_Tinv_rom is 
...
architecture arch of Accelerator_Tinv is
    component Accelerator_Tinv_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Accelerator_Tinv_rom_U :  component Accelerator_Tinv_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
