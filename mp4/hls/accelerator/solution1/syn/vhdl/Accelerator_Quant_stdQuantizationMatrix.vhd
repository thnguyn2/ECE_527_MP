...
entity Accelerator_Quant_stdQuantizationMatrix_rom is 
    generic(
             dwidth     : integer := 32; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of Accelerator_Quant_stdQuantizationMatrix_rom is 
...
entity Accelerator_Quant_stdQuantizationMatrix is
    generic (
...
architecture arch of Accelerator_Quant_stdQuantizationMatrix is
    component Accelerator_Quant_stdQuantizationMatrix_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Accelerator_Quant_stdQuantizationMatrix_rom_U :  component Accelerator_Quant_stdQuantizationMatrix_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
