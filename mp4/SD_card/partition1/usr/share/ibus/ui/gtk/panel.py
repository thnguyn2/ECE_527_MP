...
class Panel(ibus.PanelBase):
    ...
    def __init__(self, bus):
        ...
        if appindicator is None:
            ...
            self.__appindicator = appindicator.Indicator(
                "ibus-ui-gtk", ICON_KEYBOARD,
            ...
            if self.__config.get_value("panel", "show_icon_on_systray", True):
                ...
                self.__appindicator.set_status(appindicator.STATUS_PASSIVE)
    ...
    def __set_im_icon(self, icon_name):
        ...
        if self.__appindicator:
            self.__appindicator.set_icon(icon_name)
        else:
    ...
    def __create_sys_menu(self, menu):
