...
def check_is_supported(report, ui=None):
    ...
    if status == "Active Development":
        ...
        response = ui.choice(
            "Since development is completed for the '%s' version of Ubuntu, \n"
            "you should probably use its technical support channels instead \n"
            "of this tool.\n" %(distro_codename),
            [
                "I don't know what to do",
                "Continue. I already know the fix for this problem.",
                "Continue. The problem began right after system software update.",
                "Continue. I was referred here by Support.",
                "Please point me to a good place to get support.",
                ]
            )
        if response == None:
            return False
