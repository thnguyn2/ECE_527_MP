...
var HOMEPAGE_ONLINE_PREFIX = "http://start.ubuntu.com/";
var HOMEPAGE_ONLINE_EXTRA = "sourceid=hp"
  ...
  newChannel: function(aURI) {
    ...
    if (!getIsOffline()) {
      ...
      try {
        ...
        uri = HOMEPAGE_ONLINE_PREFIX + release + "/" + searchEngineName + "/?" + HOMEPAGE_ONLINE_EXTRA;
      }
