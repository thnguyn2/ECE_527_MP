...
class UbuntuSSOProxy(BaseService):
    ...
    def port(self):
        ...
        return get_sso_pb_port()

    @property
    def cmdline(self):
        """Get the command line to run the service executable."""
        return get_activation_cmdline(UbuntuSSOProxy.name)
...
class UbuntuSSOClient(BaseClient):
    ...
    service_port = UbuntuSSOProxy.port
