...
class PackageKitEnum:
	exit = ( "unknown", "success", "failed", "cancelled", "key-required", "eula-required", "media-change-required", "killed", "need-untrusted", "cancelled-priority", "skip-transaction", )
...
ROLE_SIMULATE_REPAIR_SYSTEM = "simulate-repair-system"
