...
class AptDownloadsView(Gtk.TreeView):
    ...
    def __init__(self, transaction=None):
        ...
        column_progress.set_cell_data_func(cell_progress, self._data_progress, None)
    ...
    def _on_download_changed(self, transaction, uri, status, desc, full_size,
        ...
        try:
            ...
            is_scrolled_down = adj.get_value() + adj.get_page_size() == adj.get_upper()
            ...
            if is_scrolled_down:
                ...
                self.scroll_to_cell(model.get_path(iter), None, False, False, False)
        else:
...
class AptProgressDialog(Gtk.Dialog):
    ...
    def _on_status_changed(self, trans, status):
        ...
        # the terminal window
        if status == STATUS_COMMITTING and self.expander.terminal.get_visible():
            self._resize_to_show_details()
...
class AptConfirmDialog(Gtk.Dialog):
    ...
    def __init__(self, trans, cache=None, parent=None):
        ...
        self.column.set_cell_data_func(cell_icon, self.render_package_icon, None)
    ...
    def __init__(self, from_path, to_path, parent=None):
        ...
        _ExpandableDialog.__init__(self, parent=parent,
                                   ...
                                   buttons=(_("_Keep"), Gtk.ResponseType.NO,
                                            _("_Replace"), Gtk.ResponseType.YES))
...
class DiffView(Gtk.TextView):
    ...
    def show_diff(self, from_path, to_path):
        ...
        def insert_tagged_text(iter, text, tag):
            ...
            self.textbuffer.apply_tag_by_name(tag,
                    self.textbuffer.get_iter_at_offset(offset), iter)
...
class AptMessageDialog(_DetailsExpanderMessageDialog):
    """
    ...
    def __init__(self, enum, details=None, parent=None):
        ...
        _DetailsExpanderMessageDialog.__init__(self, text, desc,
                Gtk.STOCK_DIALOG_INFO, details, parent)
...
class AptErrorDialog(_DetailsExpanderMessageDialog):
    ...
    def __init__(self, error=None, parent=None):
        ...
        _DetailsExpanderMessageDialog.__init__(self, text, desc,
                Gtk.STOCK_DIALOG_ERROR, error.details, parent)
