...
architecture behav of DCT is 
    ...
    "DCT,hls_ip_2015_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.220000,HLS_SYN_LAT=302,HLS_SYN_TPT=303,HLS_SYN_MEM=1,HLS_SYN_DSP=80,HLS_SYN_FF=15272,HLS_SYN_LUT=28920}";
