...
############################################################
set_directive_array_partition -type complete -dim 0 "MAT_Multiply" A
set_directive_array_partition -type complete -dim 0 "MAT_Multiply2" B
set_directive_array_partition -type complete -dim 0 "MAT_Multiply2" A_cached_row
set_directive_interface -mode ap_fifo "DCT" X
set_directive_interface -mode ap_fifo "DCT" Y
