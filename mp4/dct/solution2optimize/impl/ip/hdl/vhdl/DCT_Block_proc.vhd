...
begin
    ...
    X_read_assign_proc : process(ap_sig_cseq_ST_st1_fsm_0, ap_sig_bdd_43)
    begin
    ...
    Y_write_assign_proc : process(ap_sig_cseq_ST_st1_fsm_0, ap_sig_bdd_43)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_bdd_43))) then 
    ...
    ap_sig_bdd_43_assign_proc : process(ap_start, ap_done_reg, X_empty_n, Y_full_n)
    begin
                ap_sig_bdd_43 <= ((X_empty_n = ap_const_logic_0) or (Y_full_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
