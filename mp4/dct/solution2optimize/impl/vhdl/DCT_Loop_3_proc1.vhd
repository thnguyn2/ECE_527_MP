...
architecture behav of DCT_Loop_3_proc1 is 
    ...
    signal write_idx_1_fu_77_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal write_idx_1_reg_119 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_8_fu_95_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_continue)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((exitcond_fu_71_p2 = ap_const_lv1_0)))) then 
    ...
    -- write_idx_reg_59 assign process. --
    write_idx_reg_59_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and not((Y_full_n = ap_const_logic_0)))) then 
                write_idx_reg_59 <= write_idx_1_reg_119;
            elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_bdd_45))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (exitcond_fu_71_p2 = ap_const_lv1_0))) then
                tmp_reg_124 <= write_idx_reg_59(6 downto 6);
            end if;
        end if;
    end process;
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, Y_full_n, ap_sig_bdd_45, exitcond_fu_71_p2)
    begin
        case ap_CS_fsm is
            when ap_ST_st1_fsm_0 => 
                if (not(ap_sig_bdd_45)) then
                    ap_NS_fsm <= ap_ST_st2_fsm_1;
                else
                    ap_NS_fsm <= ap_ST_st1_fsm_0;
                end if;
            when ap_ST_st2_fsm_1 => 
                if (not((exitcond_fu_71_p2 = ap_const_lv1_0))) then
                    ap_NS_fsm <= ap_ST_st1_fsm_0;
                else
    ...
    Y_din <= 
        p_read when (tmp_reg_124(0) = '1') else 
        tempval_fu_100_p1;
    ...
    Ymat_address0 <= tmp_8_fu_95_p1(6 - 1 downto 0);
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_sig_cseq_ST_st2_fsm_1, exitcond_fu_71_p2)
    begin
        if (((ap_const_logic_1 = ap_done_reg) or ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((exitcond_fu_71_p2 = ap_const_lv1_0))))) then 
    ...
    ap_ready_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, exitcond_fu_71_p2)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((exitcond_fu_71_p2 = ap_const_lv1_0)))) then 
    ...
    ap_sig_bdd_45_assign_proc : process(ap_start, ap_done_reg)
    begin
                ap_sig_bdd_45 <= ((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    tmp_8_fu_95_p1 <= std_logic_vector(resize(unsigned(tmp_34_fu_91_p1),64));
