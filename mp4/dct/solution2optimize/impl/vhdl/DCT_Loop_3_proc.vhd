...
architecture behav of DCT_Loop_3_proc is 
    ...
    signal write_idx_1_fu_67_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal write_idx_1_reg_105 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_sig_cseq_ST_st2_fsm_1 : STD_LOGIC;
    signal ap_sig_bdd_46 : BOOLEAN;
    signal tmp_1_reg_110 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond_fu_61_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal write_idx_reg_49 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_sig_bdd_62 : BOOLEAN;
    signal ap_sig_cseq_ST_st3_fsm_2 : STD_LOGIC;
    signal ap_sig_bdd_70 : BOOLEAN;
    signal tmp_5_fu_85_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_2_fu_81_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_fu_90_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    -- write_idx_reg_49 assign process. --
    write_idx_reg_49_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (exitcond_fu_61_p2 = ap_const_lv1_0))) then
                tmp_1_reg_110 <= write_idx_reg_49(6 downto 6);
            end if;
        end if;
    end process;
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, Y_full_n, exitcond_fu_61_p2, ap_sig_bdd_62)
    begin
        case ap_CS_fsm is
    ...
    Y_din <= 
        ap_const_lv32_0 when (tmp_1_reg_110(0) = '1') else 
        tmp_fu_90_p1;
    ...
    Ymat_address0 <= tmp_5_fu_85_p1(6 - 1 downto 0);
    ...
    exitcond_fu_61_p2 <= "1" when (write_idx_reg_49 = ap_const_lv7_41) else "0";
    tmp_2_fu_81_p1 <= write_idx_reg_49(6 - 1 downto 0);
    tmp_5_fu_85_p1 <= std_logic_vector(resize(unsigned(tmp_2_fu_81_p1),64));
    tmp_fu_90_p1 <= Ymat_q0;
    write_idx_1_fu_67_p2 <= std_logic_vector(unsigned(write_idx_reg_49) + unsigned(ap_const_lv7_1));
end behav;
