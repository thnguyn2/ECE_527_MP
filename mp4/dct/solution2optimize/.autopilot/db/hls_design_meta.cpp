...
const Port_Property HLS_Design_Meta::port_props[]={
	Port_Property("X_dout", 32, hls_in, 0, "ap_fifo", "fifo_data", 0),
	Port_Property("X_empty_n", 1, hls_in, 0, "ap_fifo", "fifo_status", 0),
	Port_Property("X_read", 1, hls_out, 0, "ap_fifo", "fifo_update", 0),
