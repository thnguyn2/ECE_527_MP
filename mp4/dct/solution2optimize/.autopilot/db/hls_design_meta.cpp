...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("Y_din", 32, hls_out, 1, "ap_fifo", "fifo_data", 1),
	Port_Property("Y_full_n", 1, hls_in, 1, "ap_fifo", "fifo_status", 1),
	Port_Property("Y_write", 1, hls_out, 1, "ap_fifo", "fifo_update", 1),
};
