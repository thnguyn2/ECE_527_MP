...
@.str8 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1 ; [#uses=13 type=[1 x i8]*]
@.str19 = private unnamed_addr constant [8 x i8] c"ap_fifo\00", align 1 ; [#uses=3 type=[8 x i8]*]
...
codeRepl:
  ...
  call fastcc void @Loop_1_proc(i32* %Y)
  ret void, !dbg !47                              ; [debug line = 44:1]
}
...
; [#uses=1]
define internal fastcc void @Loop_1_proc(i32* %Y) nounwind {
newFuncRoot:
...
; <label>:0                                       ; preds = %2, %newFuncRoot
  ...
  %.01.i.idx.i = phi i7 [ 0, %newFuncRoot ], [ %count, %2 ] ; [#uses=3 type=i7]
  %exitcond4.i.i = icmp eq i4 %rowrcv.0.i.i, -8, !dbg !48 ; [#uses=1 type=i1] [debug line = 20:7]
  %1 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond4.i.i, label %DCT_.exit2.exitStub, label %5, !dbg !48 ; [debug line = 20:7]

; <label>:2                                       ; preds = %3
  %rowrcv = add i4 %rowrcv.0.i.i, 1, !dbg !50     ; [#uses=1 type=i4] [debug line = 20:25]
  call void @llvm.dbg.value(metadata !{i4 %rowrcv}, i64 0, metadata !51), !dbg !50 ; [debug line = 20:25] [debug variable = rowrcv]
  br label %0, !dbg !50                           ; [debug line = 20:25]

; <label>:3                                       ; preds = %6, %5
  %.12.rec.i.i = phi i4 [ 0, %5 ], [ %.rec.i.i, %6 ] ; [#uses=3 type=i4]
  %count.1.i.i = phi i7 [ %.01.i.idx.i, %5 ], [ %tmp.i, %6 ] ; [#uses=1 type=i7]
  %.12.rec.i.i.cast5 = zext i4 %.12.rec.i.i to i7 ; [#uses=1 type=i7]
  %.01.i.idx9.i = add i7 %.12.rec.i.i.cast5, %.01.i.idx.i ; [#uses=1 type=i7]
  ...
  %exitcond = icmp eq i4 %.12.rec.i.i, -8, !dbg !52 ; [#uses=1 type=i1] [debug line = 21:8]
  br i1 %exitcond, label %2, label %6, !dbg !52   ; [debug line = 21:8]

; <label>:5                                       ; preds = %0
  %count = add i7 %.01.i.idx.i, 8, !dbg !52       ; [#uses=1 type=i7] [debug line = 21:8]
  call void @llvm.dbg.value(metadata !{i7 %count}, i64 0, metadata !54), !dbg !55 ; [debug line = 24:4] [debug variable = count]
  br label %3, !dbg !52                           ; [debug line = 21:8]

; <label>:6                                       ; preds = %3
  %.rec.i.i = add i4 %.12.rec.i.i, 1, !dbg !57    ; [#uses=1 type=i4] [debug line = 25:4]
  %tmp.i = add i7 %count.1.i.i, 1, !dbg !55       ; [#uses=2 type=i7] [debug line = 24:4]
  %tmp.i.cast = zext i7 %tmp.i to i32, !dbg !55   ; [#uses=1 type=i32] [debug line = 24:4]
  store i32 %tmp.i.cast, i32* %Y.addr, align 4, !dbg !57 ; [debug line = 25:4]
  br label %3, !dbg !58                           ; [debug line = 21:26]
}
...
!47 = metadata !{i32 44, i32 1, metadata !12, null}
!48 = metadata !{i32 20, i32 7, metadata !49, null}
!49 = metadata !{i32 786443, metadata !12, i32 20, i32 2, metadata !14, i32 1} ; [ DW_TAG_lexical_block ]
!50 = metadata !{i32 20, i32 25, metadata !49, null}
...
!53 = metadata !{i32 786443, metadata !49, i32 21, i32 3, metadata !14, i32 2} ; [ DW_TAG_lexical_block ]
!54 = metadata !{i32 786688, metadata !12, metadata !"count", metadata !14, i32 17, metadata !18, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!55 = metadata !{i32 24, i32 4, metadata !56, null}
!56 = metadata !{i32 786443, metadata !53, i32 22, i32 3, metadata !14, i32 3} ; [ DW_TAG_lexical_block ]
!57 = metadata !{i32 25, i32 4, metadata !56, null}
!58 = metadata !{i32 21, i32 26, metadata !53, null}
