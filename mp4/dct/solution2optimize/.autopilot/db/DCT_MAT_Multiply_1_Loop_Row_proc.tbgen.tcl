set moduleName DCT_MAT_Multiply_1_Loop_Row_proc
...
set isOneStateSeq 0
set C_modelName {DCT_MAT_Multiply.1_Loop_Row_proc}
...
set portList { 
	...
	{ C_address0 sc_out sc_lv 6 signal 72 } 
	{ C_ce0 sc_out sc_logic 1 signal 72 } 
	{ C_we0 sc_out sc_logic 1 signal 72 } 
	{ C_d0 sc_out sc_lv 32 signal 72 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	A { ap_memory {  { A_address0 mem_address 1 3 }  { A_ce0 mem_ce 1 1 }  { A_q0 mem_dout 0 32 }  { A_address1 mem_address 1 3 }  { A_ce1 mem_ce 1 1 }  { A_q1 mem_dout 0 32 } } }
	A1 { ap_memory {  { A1_address0 mem_address 1 3 }  { A1_ce0 mem_ce 1 1 }  { A1_q0 mem_dout 0 32 }  { A1_address1 mem_address 1 3 }  { A1_ce1 mem_ce 1 1 }  { A1_q1 mem_dout 0 32 } } }
	A2 { ap_memory {  { A2_address0 mem_address 1 3 }  { A2_ce0 mem_ce 1 1 }  { A2_q0 mem_dout 0 32 }  { A2_address1 mem_address 1 3 }  { A2_ce1 mem_ce 1 1 }  { A2_q1 mem_dout 0 32 } } }
	A3 { ap_memory {  { A3_address0 mem_address 1 3 }  { A3_ce0 mem_ce 1 1 }  { A3_q0 mem_dout 0 32 }  { A3_address1 mem_address 1 3 }  { A3_ce1 mem_ce 1 1 }  { A3_q1 mem_dout 0 32 } } }
	A4 { ap_memory {  { A4_address0 mem_address 1 3 }  { A4_ce0 mem_ce 1 1 }  { A4_q0 mem_dout 0 32 }  { A4_address1 mem_address 1 3 }  { A4_ce1 mem_ce 1 1 }  { A4_q1 mem_dout 0 32 } } }
	A5 { ap_memory {  { A5_address0 mem_address 1 3 }  { A5_ce0 mem_ce 1 1 }  { A5_q0 mem_dout 0 32 }  { A5_address1 mem_address 1 3 }  { A5_ce1 mem_ce 1 1 }  { A5_q1 mem_dout 0 32 } } }
	A6 { ap_memory {  { A6_address0 mem_address 1 3 }  { A6_ce0 mem_ce 1 1 }  { A6_q0 mem_dout 0 32 }  { A6_address1 mem_address 1 3 }  { A6_ce1 mem_ce 1 1 }  { A6_q1 mem_dout 0 32 } } }
	A7 { ap_memory {  { A7_address0 mem_address 1 3 }  { A7_ce0 mem_ce 1 1 }  { A7_q0 mem_dout 0 32 }  { A7_address1 mem_address 1 3 }  { A7_ce1 mem_ce 1 1 }  { A7_q1 mem_dout 0 32 } } }
