...
set C_modelArgList { 
	...
	{ Ymat float 32 regular {array 64 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ Ymat_address0 sc_out sc_lv 6 signal 1 } 
	{ Ymat_ce0 sc_out sc_logic 1 signal 1 } 
	{ Ymat_q0 sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Ymat_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Ymat", "role": "q0" }}  ]}
set Spec2ImplPortList { 
	Y { ap_fifo {  { Y_din fifo_data 1 32 }  { Y_full_n fifo_status 0 1 }  { Y_write fifo_update 1 1 } } }
	Ymat { ap_memory {  { Ymat_address0 mem_address 1 6 }  { Ymat_ce0 mem_ce 1 1 }  { Ymat_q0 mem_dout 0 32 } } }
}
