...
struct DCT_MAT_Multiply : public sc_module {
    ...
    sc_signal< sc_lv<6> > DCT_MAT_Multiply_Loop_Row_proc_U0_C_address0;
    sc_signal< sc_logic > DCT_MAT_Multiply_Loop_Row_proc_U0_C_ce0;
    sc_signal< sc_logic > DCT_MAT_Multiply_Loop_Row_proc_U0_C_we0;
    sc_signal< sc_lv<32> > DCT_MAT_Multiply_Loop_Row_proc_U0_C_d0;
