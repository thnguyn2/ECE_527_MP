...
struct DCT : public sc_module {
    ...
    sc_signal< sc_logic > DCT_Block_proc_U0_ap_start;
    sc_signal< sc_logic > DCT_Block_proc_U0_ap_done;
    ...
    sc_signal< sc_lv<32> > DCT_Block_proc_U0_Y_din;
    ...
    void thread_DCT_Block_proc_U0_X_dout();
