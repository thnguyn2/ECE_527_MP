...
#ifndef _DCT_MAT_Multiply_Loop_Row_proc440_HH_
#define _DCT_MAT_Multiply_Loop_Row_proc440_HH_
...
struct DCT_MAT_Multiply_Loop_Row_proc440 : public sc_module {
    ...
    // Module declarations
    DCT_MAT_Multiply_Loop_Row_proc440(sc_module_name name);
    SC_HAS_PROCESS(DCT_MAT_Multiply_Loop_Row_proc440);

    ~DCT_MAT_Multiply_Loop_Row_proc440();
