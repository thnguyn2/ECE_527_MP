...
DCT_MAT_Multiply::DCT_MAT_Multiply(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    DCT_MAT_Multiply_Loop_Row_proc_U0->C_address0(DCT_MAT_Multiply_Loop_Row_proc_U0_C_address0);
    DCT_MAT_Multiply_Loop_Row_proc_U0->C_ce0(DCT_MAT_Multiply_Loop_Row_proc_U0_C_ce0);
    DCT_MAT_Multiply_Loop_Row_proc_U0->C_we0(DCT_MAT_Multiply_Loop_Row_proc_U0_C_we0);
    DCT_MAT_Multiply_Loop_Row_proc_U0->C_d0(DCT_MAT_Multiply_Loop_Row_proc_U0_C_d0);
    ...
    sensitive << ( DCT_MAT_Multiply_Loop_Row_proc_U0_C_address0 );

    SC_METHOD(thread_C_address1);

    SC_METHOD(thread_C_ce0);
    sensitive << ( DCT_MAT_Multiply_Loop_Row_proc_U0_C_ce0 );

    SC_METHOD(thread_C_ce1);

    SC_METHOD(thread_C_d0);
    sensitive << ( DCT_MAT_Multiply_Loop_Row_proc_U0_C_d0 );

    SC_METHOD(thread_C_d1);

    SC_METHOD(thread_C_we0);
    sensitive << ( DCT_MAT_Multiply_Loop_Row_proc_U0_C_we0 );
    ...
    sc_trace(mVcdFile, DCT_MAT_Multiply_Loop_Row_proc_U0_C_address0, "DCT_MAT_Multiply_Loop_Row_proc_U0_C_address0");
    sc_trace(mVcdFile, DCT_MAT_Multiply_Loop_Row_proc_U0_C_ce0, "DCT_MAT_Multiply_Loop_Row_proc_U0_C_ce0");
    sc_trace(mVcdFile, DCT_MAT_Multiply_Loop_Row_proc_U0_C_we0, "DCT_MAT_Multiply_Loop_Row_proc_U0_C_we0");
    sc_trace(mVcdFile, DCT_MAT_Multiply_Loop_Row_proc_U0_C_d0, "DCT_MAT_Multiply_Loop_Row_proc_U0_C_d0");
...
void DCT_MAT_Multiply::thread_B_read() {
    B_read = DCT_MAT_Multiply_Loop_LoadRow_proc_U0_B_read.read();
}

void DCT_MAT_Multiply::thread_C_address0() {
    C_address0 = DCT_MAT_Multiply_Loop_Row_proc_U0_C_address0.read();
}

void DCT_MAT_Multiply::thread_C_address1() {
    C_address1 = ap_const_lv6_0;
}

void DCT_MAT_Multiply::thread_C_ce0() {
    C_ce0 = DCT_MAT_Multiply_Loop_Row_proc_U0_C_ce0.read();
}

void DCT_MAT_Multiply::thread_C_ce1() {
    C_ce1 = ap_const_logic_0;
}

void DCT_MAT_Multiply::thread_C_d0() {
    C_d0 = DCT_MAT_Multiply_Loop_Row_proc_U0_C_d0.read();
}

void DCT_MAT_Multiply::thread_C_d1() {
    C_d1 = ap_const_lv32_0;
}

void DCT_MAT_Multiply::thread_C_we0() {
    C_we0 = DCT_MAT_Multiply_Loop_Row_proc_U0_C_we0.read();
}

void DCT_MAT_Multiply::thread_C_we1() {
    C_we1 = ap_const_logic_0;
}

void DCT_MAT_Multiply::thread_DCT_MAT_Multiply_Loop_LoadRow_proc_U0_B_dout() {
    DCT_MAT_Multiply_Loop_LoadRow_proc_U0_B_dout = B_dout.read();
}

void DCT_MAT_Multiply::thread_DCT_MAT_Multiply_Loop_LoadRow_proc_U0_B_empty_n() {
    DCT_MAT_Multiply_Loop_LoadRow_proc_U0_B_empty_n = B_empty_n.read();
}

void DCT_MAT_Multiply::thread_DCT_MAT_Multiply_Loop_LoadRow_proc_U0_ap_continue() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_ready_B_cached_0_6_channel_full_n.read()) && 
...
void DCT_MAT_Multiply::thread_DCT_MAT_Multiply_Loop_LoadRow_proc_U0_ap_start() {
    if ( ap_rst.read() == ap_const_logic_1) {
        DCT_MAT_Multiply_Loop_LoadRow_proc_U0_ap_start = ap_const_logic_0;
    } else {
...
void DCT_MAT_Multiply::thread_ap_sig_start_in_DCT_MAT_Multiply_Loop_LoadRow_proc_U0_ap_start() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_start.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_0, ap_reg_ready_DCT_MAT_Multiply_Loop_LoadRow_proc_U0_ap_ready.read()))) {
...
void DCT_MAT_Multiply::thread_ap_sig_top_allready() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_ready_DCT_MAT_Multiply_Loop_Row_proc_U0_ap_ready.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_ready_DCT_MAT_Multiply_Loop_LoadRow_proc_U0_ap_ready.read()))) {
