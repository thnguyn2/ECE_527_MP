...
DCT_Loop_3_proc::DCT_Loop_3_proc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( p_01_rec_cast_fu_57_p1 );
    ...
    sensitive << ( ap_sig_cseq_ST_st2_fsm_1 );
    sensitive << ( p_01_rec_reg_45 );

    SC_METHOD(thread_p_01_rec_cast_fu_57_p1);
    sensitive << ( p_01_rec_reg_45 );

    SC_METHOD(thread_write_idx_fu_68_p2);
    sensitive << ( p_01_rec_reg_45 );
    ...
    sc_trace(mVcdFile, Ybuff_q0, "(port)Ybuff_q0");
#endif
    ...
    sc_trace(mVcdFile, write_idx_fu_68_p2, "write_idx_fu_68_p2");
    sc_trace(mVcdFile, write_idx_reg_82, "write_idx_reg_82");
    sc_trace(mVcdFile, ap_sig_cseq_ST_st2_fsm_1, "ap_sig_cseq_ST_st2_fsm_1");
    sc_trace(mVcdFile, ap_sig_bdd_46, "ap_sig_bdd_46");
    sc_trace(mVcdFile, exitcond_fu_62_p2, "exitcond_fu_62_p2");
    sc_trace(mVcdFile, p_01_rec_reg_45, "p_01_rec_reg_45");
    sc_trace(mVcdFile, ap_sig_cseq_ST_st3_fsm_2, "ap_sig_cseq_ST_st3_fsm_2");
    sc_trace(mVcdFile, ap_sig_bdd_61, "ap_sig_bdd_61");
    sc_trace(mVcdFile, ap_sig_bdd_70, "ap_sig_bdd_70");
    sc_trace(mVcdFile, p_01_rec_cast_fu_57_p1, "p_01_rec_cast_fu_57_p1");
...
void DCT_Loop_3_proc::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
        ...
        p_01_rec_reg_45 = write_idx_reg_82.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read())) {
        write_idx_reg_82 = write_idx_fu_68_p2.read();
    }
}
...
void DCT_Loop_3_proc::thread_Ybuff_address0() {
    Ybuff_address0 =  (sc_lv<7>) (p_01_rec_cast_fu_57_p1.read());
}

void DCT_Loop_3_proc::thread_Ybuff_ce0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read())) {
...
void DCT_Loop_3_proc::thread_ap_sig_bdd_61() {
...
void DCT_Loop_3_proc::thread_exitcond_fu_62_p2() {
    exitcond_fu_62_p2 = (!p_01_rec_reg_45.read().is_01() || !ap_const_lv7_41.is_01())? sc_lv<1>(): sc_lv<1>(p_01_rec_reg_45.read() == ap_const_lv7_41);
}

void DCT_Loop_3_proc::thread_p_01_rec_cast_fu_57_p1() {
    p_01_rec_cast_fu_57_p1 = esl_zext<64,7>(p_01_rec_reg_45.read());
}

void DCT_Loop_3_proc::thread_write_idx_fu_68_p2() {
    write_idx_fu_68_p2 = (!p_01_rec_reg_45.read().is_01() || !ap_const_lv7_1.is_01())? sc_lv<7>(): (sc_biguint<7>(p_01_rec_reg_45.read()) + sc_biguint<7>(ap_const_lv7_1));
}
