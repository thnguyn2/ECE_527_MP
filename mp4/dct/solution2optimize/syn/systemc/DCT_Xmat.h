...
protected:
    ...
    DCT_Xmat_memcore* DCT_Xmat_memcore_U;
...
public:
    ~DCT_Xmat();
    SC_CTOR(DCT_Xmat) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        DCT_Xmat_memcore_U = new DCT_Xmat_memcore("DCT_Xmat_memcore_U");
        DCT_Xmat_memcore_U->clk      ( clk );
        DCT_Xmat_memcore_U->reset    ( reset );
        DCT_Xmat_memcore_U->ce0      ( i_ce0 );
        DCT_Xmat_memcore_U->we0      ( i_we0 );
        DCT_Xmat_memcore_U->address0 ( memcore_iaddr );
        DCT_Xmat_memcore_U->d0       ( i_d0 );
        DCT_Xmat_memcore_U->q0       ( i_q0 );

        DCT_Xmat_memcore_U->ce1      ( t_ce0 );
        DCT_Xmat_memcore_U->we1      ( t_we0 );
        DCT_Xmat_memcore_U->address1 ( memcore_taddr );
        DCT_Xmat_memcore_U->d1       ( t_d0 );
        DCT_Xmat_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "DCT_Xmat.trace");
            // ports
