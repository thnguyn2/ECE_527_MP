...
architecture behav of DCT_Loop_3_proc is 
    ...
    signal p_01_rec_reg_45 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_sig_cseq_ST_st3_fsm_2 : STD_LOGIC;
    signal ap_sig_bdd_61 : BOOLEAN;
    signal ap_sig_bdd_70 : BOOLEAN;
    signal p_01_rec_cast_fu_57_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_continue)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((exitcond_fu_62_p2 = ap_const_lv1_0)))) then 
    ...
    -- p_01_rec_reg_45 assign process. --
    p_01_rec_reg_45_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, Y_full_n, exitcond_fu_62_p2, ap_sig_bdd_70)
    begin
        case ap_CS_fsm is
    ...
    Ybuff_address0 <= p_01_rec_cast_fu_57_p1(7 - 1 downto 0);

    -- Ybuff_ce0 assign process. --
    Ybuff_ce0_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_sig_cseq_ST_st2_fsm_1, exitcond_fu_62_p2)
    begin
        if (((ap_const_logic_1 = ap_done_reg) or ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((exitcond_fu_62_p2 = ap_const_lv1_0))))) then 
    ...
    exitcond_fu_62_p2 <= "1" when (p_01_rec_reg_45 = ap_const_lv7_41) else "0";
    p_01_rec_cast_fu_57_p1 <= std_logic_vector(resize(unsigned(p_01_rec_reg_45),64));
    write_idx_fu_68_p2 <= std_logic_vector(unsigned(p_01_rec_reg_45) + unsigned(ap_const_lv7_1));
end behav;
