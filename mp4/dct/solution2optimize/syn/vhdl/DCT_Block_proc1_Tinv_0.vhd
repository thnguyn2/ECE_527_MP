...
entity DCT_Block_proc1_Tinv_0_rom is 
    generic(
             dwidth     : integer := 32; 
             awidth     : integer := 3; 
             mem_size    : integer := 8
...
architecture rtl of DCT_Block_proc1_Tinv_0_rom is 
...
entity DCT_Block_proc1_Tinv_0 is
    generic (
...
architecture arch of DCT_Block_proc1_Tinv_0 is
    component DCT_Block_proc1_Tinv_0_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    DCT_Block_proc1_Tinv_0_rom_U :  component DCT_Block_proc1_Tinv_0_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
