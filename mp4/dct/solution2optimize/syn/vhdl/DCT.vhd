...
architecture behav of DCT is 
    ...
    "DCT,hls_ip_2015_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.641000,HLS_SYN_LAT=495,HLS_SYN_TPT=496,HLS_SYN_MEM=2,HLS_SYN_DSP=50,HLS_SYN_FF=12683,HLS_SYN_LUT=20909}";
    ...
    signal DCT_Block_proc_U0_Y_din : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    DCT_Block_proc_U0 : component DCT_Block_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    begin
        if ((DCT_Block_proc_U0_ap_done = ap_const_logic_1)) then 
