...
#ifndef __DCT_sitofp_32ns_32_6__HH__
#define __DCT_sitofp_32ns_32_6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_sitofp_32ns_32_6) {
    ...
    SC_CTOR(DCT_sitofp_32ns_32_6):  ACMP_sitofp_U ("ACMP_sitofp_U") {
