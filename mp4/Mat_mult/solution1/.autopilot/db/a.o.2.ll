...
; [#uses=0]
define void @MAT_Multiply([50 x [50 x i32]]* %A, [50 x [50 x i32]]* %B, [50 x [50 x i64]]* %C, i8 zeroext %mA, i8 zeroext %nA, i8 zeroext %mB, i8 zeroext %nB, i8 zeroext %mC, i8 zeroext %nC) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap([50 x [50 x i32]]* %A) nounwind, !map !20
  call void (...)* @_ssdm_op_SpecBitsMap([50 x [50 x i32]]* %B) nounwind, !map !26
  call void (...)* @_ssdm_op_SpecBitsMap([50 x [50 x i64]]* %C) nounwind, !map !30
  ...
  call void @llvm.dbg.value(metadata !{[50 x [50 x i32]]* %A}, i64 0, metadata !60), !dbg !63 ; [debug line = 4:23] [debug variable = A]
  call void @llvm.dbg.value(metadata !{[50 x [50 x i32]]* %B}, i64 0, metadata !64), !dbg !65 ; [debug line = 5:7] [debug variable = B]
  call void @llvm.dbg.value(metadata !{[50 x [50 x i64]]* %C}, i64 0, metadata !66), !dbg !68 ; [debug line = 5:23] [debug variable = C]
...
.preheader8:                                      ; preds = %14, %0
  %i = phi i6 [ %i.1, %14 ], [ 0, %0 ]            ; [#uses=5 type=i6]
...
; <label>:2                                       ; preds = %.preheader8
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @.str) nounwind, !dbg !90 ; [debug line = 17:4]
  %tmp.2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @.str) nounwind, !dbg !90 ; [#uses=1 type=i32] [debug line = 17:4]
  ...
  %tmp.7 = zext i6 %i to i64, !dbg !97            ; [#uses=2 type=i64] [debug line = 27:8]
  br label %3, !dbg !101                          ; [debug line = 17:14]

; <label>:3                                       ; preds = %.loopexit, %2
  %j = phi i6 [ 0, %2 ], [ %j.1, %.loopexit ]     ; [#uses=7 type=i6]
  %j.cast5 = zext i6 %j to i8, !dbg !101          ; [#uses=1 type=i8] [debug line = 17:14]
  %exitcond3 = icmp eq i6 %j, -14, !dbg !101      ; [#uses=1 type=i1] [debug line = 17:14]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 50, i64 50, i64 50) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond3, label %14, label %5, !dbg !101 ; [debug line = 17:14]

; <label>:5                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @.str1) nounwind, !dbg !102 ; [debug line = 18:5]
  %tmp.19 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @.str1) nounwind, !dbg !102 ; [#uses=1 type=i32] [debug line = 18:5]
...
; <label>:6                                       ; preds = %5
  %tmp.8 = icmp eq i6 %j, 0, !dbg !103            ; [#uses=1 type=i1] [debug line = 23:6]
  br i1 %tmp.8, label %.preheader6, label %.loopexit7, !dbg !103 ; [debug line = 23:6]

.preheader6:                                      ; preds = %8, %6
  %k = phi i6 [ %k.3, %8 ], [ 0, %6 ]             ; [#uses=3 type=i6]
  %exitcond2 = icmp eq i6 %k, -14, !dbg !104      ; [#uses=1 type=i1] [debug line = 26:24]
  %7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 50, i64 50, i64 50) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond2, label %.loopexit7, label %8, !dbg !104 ; [debug line = 26:24]

; <label>:8                                       ; preds = %.preheader6
  call void (...)* @_ssdm_op_SpecLoopName([11 x i8]* @.str2) nounwind, !dbg !97 ; [debug line = 27:8]
  %tmp.10 = zext i6 %k to i64, !dbg !97           ; [#uses=2 type=i64] [debug line = 27:8]
  %A.addr = getelementptr [50 x [50 x i32]]* %A, i64 0, i64 %tmp.7, i64 %tmp.10, !dbg !97 ; [#uses=1 type=i32*] [debug line = 27:8]
  %A.load = load i32* %A.addr, align 4, !dbg !97  ; [#uses=1 type=i32] [debug line = 27:8]
  %A_cached_row.addr = getelementptr inbounds [50 x i32]* %A_cached_row, i64 0, i64 %tmp.10, !dbg !97 ; [#uses=1 type=i32*] [debug line = 27:8]
  store i32 %A.load, i32* %A_cached_row.addr, align 4, !dbg !97 ; [debug line = 27:8]
...
.preheader.preheader:                             ; preds = %.loopexit7
  %tmp.11 = zext i6 %j to i64, !dbg !107          ; [#uses=2 type=i64] [debug line = 34:8]
...
; <label>:10                                      ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName([11 x i8]* @.str3) nounwind, !dbg !107 ; [debug line = 34:8]
  %tmp.12 = zext i6 %k.1 to i64, !dbg !107        ; [#uses=2 type=i64] [debug line = 34:8]
  %B.addr = getelementptr [50 x [50 x i32]]* %B, i64 0, i64 %tmp.12, i64 %tmp.11, !dbg !107 ; [#uses=1 type=i32*] [debug line = 34:8]
  %B.load = load i32* %B.addr, align 4, !dbg !107 ; [#uses=1 type=i32] [debug line = 34:8]
...
_ifconv:                                          ; preds = %11
  call void (...)* @_ssdm_op_SpecLoopName([8 x i8]* @.str4) nounwind, !dbg !117 ; [debug line = 38:7]
  %tmp.14 = icmp ult i8 %k.2.cast2, %nA, !dbg !118 ; [#uses=1 type=i1] [debug line = 39:9]
  %tmp.16 = zext i6 %k.2 to i64, !dbg !113        ; [#uses=2 type=i64] [debug line = 40:10]
  %A_cached_row.addr.1 = getelementptr inbounds [50 x i32]* %A_cached_row, i64 0, i64 %tmp.16, !dbg !113 ; [#uses=1 type=i32*] [debug line = 40:10]
  %A_cached_row.load = load i32* %A_cached_row.addr.1, align 4, !dbg !113 ; [#uses=1 type=i32] [debug line = 40:10]
  %B_cached.addr.1 = getelementptr inbounds [50 x [50 x i32]]* %B_cached, i64 0, i64 %tmp.16, i64 %tmp.13, !dbg !113 ; [#uses=1 type=i32*] [debug line = 40:10]
  %B_cached.load = load i32* %B_cached.addr.1, align 4, !dbg !113 ; [#uses=1 type=i32] [debug line = 40:10]
  %tmp.17 = mul nsw i32 %A_cached_row.load, %B_cached.load, !dbg !113 ; [#uses=1 type=i32] [debug line = 40:10]
  %tmp.18 = sext i32 %tmp.17 to i64, !dbg !113    ; [#uses=1 type=i64] [debug line = 40:10]
  %temp.3 = add nsw i64 %tmp.18, %temp, !dbg !113 ; [#uses=1 type=i64] [debug line = 40:10]
...
.loopexit:                                        ; preds = %11, %5
  ...
  %tmp.15 = zext i6 %j to i64, !dbg !121          ; [#uses=1 type=i64] [debug line = 43:5]
  %C.addr = getelementptr [50 x [50 x i64]]* %C, i64 0, i64 %tmp.7, i64 %tmp.15, !dbg !121 ; [#uses=1 type=i64*] [debug line = 43:5]
  store i64 %temp.2, i64* %C.addr, align 8, !dbg !121 ; [debug line = 43:5]
  %13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str1, i32 %tmp.19) nounwind, !dbg !122 ; [#uses=0 type=i32] [debug line = 44:4]
...
; <label>:14                                      ; preds = %3
  %15 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str, i32 %tmp.2) nounwind, !dbg !125 ; [#uses=0 type=i32] [debug line = 44:4]
...
!97 = metadata !{i32 27, i32 8, metadata !98, null}
!98 = metadata !{i32 786443, metadata !99, i32 27, i32 8, metadata !6, i32 9} ; [ DW_TAG_lexical_block ]
!99 = metadata !{i32 786443, metadata !100, i32 26, i32 19, metadata !6, i32 8} ; [ DW_TAG_lexical_block ]
!100 = metadata !{i32 786443, metadata !96, i32 24, i32 6, metadata !6, i32 7} ; [ DW_TAG_lexical_block ]
!101 = metadata !{i32 17, i32 14, metadata !94, null}
!102 = metadata !{i32 18, i32 5, metadata !93, null}
!103 = metadata !{i32 23, i32 6, metadata !96, null}
!104 = metadata !{i32 26, i32 24, metadata !99, null}
!105 = metadata !{i32 26, i32 33, metadata !99, null}
