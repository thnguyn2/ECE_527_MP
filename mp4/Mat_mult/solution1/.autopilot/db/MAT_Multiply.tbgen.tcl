...
set C_modelArgList { 
	{ A int 32 regular {array 2500 { 1 3 } 1 1 }  }
	{ B int 32 regular {array 2500 { 1 3 } 1 1 }  }
	{ C int 64 regular {array 2500 { 0 3 } 0 1 }  }
	{ mA uint 8 regular  }
	{ nA uint 8 regular  }
	{ mB uint 8 regular  }
	{ nB uint 8 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "memory", "bitwidth" : 32,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "A","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 49,"step" : 1},{"low" : 0,"up" : 49,"step" : 1}]}]}]} , 
 	{ "Name" : "B", "interface" : "memory", "bitwidth" : 32,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "B","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 49,"step" : 1},{"low" : 0,"up" : 49,"step" : 1}]}]}]} , 
 	{ "Name" : "C", "interface" : "memory", "bitwidth" : 64,"bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "C","cData": "long int","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 49,"step" : 1},{"low" : 0,"up" : 49,"step" : 1}]}]}]} , 
...
set Spec2ImplPortList { 
	...
	C { ap_memory {  { C_address0 mem_address 1 12 }  { C_ce0 mem_ce 1 1 }  { C_we0 mem_we 1 1 }  { C_d0 mem_din 1 64 } } }
