...
`define LENGTH_A 2500
`define LENGTH_B 2500
`define LENGTH_C 2500
`define LENGTH_mA 1
`define LENGTH_nA 1
`define LENGTH_mB 1
`define LENGTH_nB 1
...
wire    [11 : 0]	arrayA_address0, arrayA_address1;
...
wire    [11 : 0]	arrayB_address0, arrayB_address1;
...
always @ (posedge AESL_clock or posedge AESL_reset) begin
    ...
    begin
        ...
        if ( AESL_mLatCnterIn_addr > AESL_mLatCnterOut_addr ) begin
          if ( AESL_clk_counter - AESL_mLatCnterIn[AESL_mLatCnterOut_addr] > 5 * 1637601 ) begin
