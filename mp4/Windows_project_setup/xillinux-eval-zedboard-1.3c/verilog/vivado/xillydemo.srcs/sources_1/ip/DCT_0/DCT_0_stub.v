...
module DCT_0(X_dout, X_empty_n, X_read, function_r, Y_din, Y_full_n, Y_write, ap_clk, ap_rst)
/* synthesis syn_black_box black_box_pad_pin="X_dout[31:0],X_empty_n,X_read,function_r[7:0],Y_din[31:0],Y_full_n,Y_write,ap_clk,ap_rst" */;
  input [31:0]X_dout;
  input X_empty_n;
  output X_read;
